...
const About: FC = () => (
  <>
    ...
    <div className="text-center p-5 relative z-10">
      <h1 className="text-[1.8rem] sm:text-4xl font-bold mt-16 sm:mt-32 mb-4">
      ...
      <div className="flex flex-col justify-center items-center text-base sm:text-xl max-w-xl mx-auto gap-8 my-8">
        <p>
          ...
          students. My name is Addison Goolsbee and I have too much time on my
          hands. Here's my horrendous Yalies photo, hopefully yours is a little
          better:
        </p>
        <img
