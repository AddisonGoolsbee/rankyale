 ...
 */var uv;function vS(){if(uv)return dl;uv=1;var r=Symbol.for("react.transitional.element"),t=Symbol.for("react.fragment");function n(s,o,u){var f=null;if(u!==void 0&&(f=""+u),o.key!==void 0&&(f=""+o.key),"key"in o){u={};for(var m in o)m!=="key"&&(u[m]=o[m])}else u=o;return o=u.ref,{$$typeof:r,type:s,key:f,ref:o!==void 0?o:null,props:u}}return dl.Fragment=t,dl.jsx=n,dl.jsxs=n,dl}var cv;function _S(){return cv||(cv=1,dd.exports=vS()),dd.exports}var tt=_S(),md={exports:{}},Rt={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var hv;function ES(){if(hv)return Rt;hv=1;var r=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),n=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),f=Symbol.for("react.context"),m=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),y=Symbol.for("react.memo"),E=Symbol.for("react.lazy"),b=Symbol.iterator;function V(D){return D===null||typeof D!="object"?null:(D=b&&D[b]||D["@@iterator"],typeof D=="function"?D:null)}var B={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},Q=Object.assign,X={};function F(D,Y,at){this.props=D,this.context=Y,this.refs=X,this.updater=at||B}F.prototype.isReactComponent={},F.prototype.setState=function(D,Y){if(typeof D!="object"&&typeof D!="function"&&D!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,D,Y,"setState")},F.prototype.forceUpdate=function(D){this.updater.enqueueForceUpdate(this,D,"forceUpdate")};function rt(){}rt.prototype=F.prototype;function ut(D,Y,at){this.props=D,this.context=Y,this.refs=X,this.updater=at||B}var ht=ut.prototype=new rt;ht.constructor=ut,Q(ht,F.prototype),ht.isPureReactComponent=!0;var bt=Array.isArray,mt={H:null,A:null,T:null,S:null},Ot=Object.prototype.hasOwnProperty;function M(D,Y,at,nt,it,vt){return at=vt.ref,{$$typeof:r,type:D,key:Y,ref:at!==void 0?at:null,props:vt}}function I(D,Y){return M(D.type,Y,void 0,void 0,void 0,D.props)}function S(D){return typeof D=="object"&&D!==null&&D.$$typeof===r}function C(D){var Y={"=":"=0",":":"=2"};return"$"+D.replace(/[=:]/g,function(at){return Y[at]})}var N=/\/+/g;function U(D,Y){return typeof D=="object"&&D!==null&&D.key!=null?C(""+D.key):Y.toString(36)}function w(){}function Ct(D){switch(D.status){case"fulfilled":return D.value;case"rejected":throw D.reason;default:switch(typeof D.status=="string"?D.then(w,w):(D.status="pending",D.then(function(Y){D.status==="pending"&&(D.status="fulfilled",D.value=Y)},function(Y){D.status==="pending"&&(D.status="rejected",D.reason=Y)})),D.status){case"fulfilled":return D.value;case"rejected":throw D.reason}}throw D}function Et(D,Y,at,nt,it){var vt=typeof D;(vt==="undefined"||vt==="boolean")&&(D=null);var Tt=!1;if(D===null)Tt=!0;else switch(vt){case"bigint":case"string":case"number":Tt=!0;break;case"object":switch(D.$$typeof){case r:case t:Tt=!0;break;case E:return Tt=D._init,Et(Tt(D._payload),Y,at,nt,it)}}if(Tt)return it=it(D),Tt=nt===""?"."+U(D,0):nt,bt(it)?(at="",Tt!=null&&(at=Tt.replace(N,"$&/")+"/"),Et(it,Y,at,"",function(ie){return ie})):it!=null&&(S(it)&&(it=I(it,at+(it.key==null||D&&D.key===it.key?"":(""+it.key).replace(N,"$&/")+"/")+Tt)),Y.push(it)),1;Tt=0;var de=nt===""?".":nt+":";if(bt(D))for(var qt=0;qt<D.length;qt++)nt=D[qt],vt=de+U(nt,qt),Tt+=Et(nt,Y,at,vt,it);else if(qt=V(D),typeof qt=="function")for(D=qt.call(D),qt=0;!(nt=D.next()).done;)nt=nt.value,vt=de+U(nt,qt++),Tt+=Et(nt,Y,at,vt,it);else if(vt==="object"){if(typeof D.then=="function")return Et(Ct(D),Y,at,nt,it);throw Y=String(D),Error("Objects are not valid as a React child (found: "+(Y==="[object Object]"?"object with keys {"+Object.keys(D).join(", ")+"}":Y)+"). If you meant to render a collection of children, use an array instead.")}return Tt}function Z(D,Y,at){if(D==null)return D;var nt=[],it=0;return Et(D,nt,"","",function(vt){return Y.call(at,vt,it++)}),nt}function ct(D){if(D._status===-1){var Y=D._result;Y=Y(),Y.then(function(at){(D._status===0||D._status===-1)&&(D._status=1,D._result=at)},function(at){(D._status===0||D._status===-1)&&(D._status=2,D._result=at)}),D._status===-1&&(D._status=0,D._result=Y)}if(D._status===1)return D._result.default;throw D._result}var st=typeof reportError=="function"?reportError:function(D){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var Y=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof D=="object"&&D!==null&&typeof D.message=="string"?String(D.message):String(D),error:D});if(!window.dispatchEvent(Y))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",D);return}console.error(D)};function It(){}return Rt.Children={map:Z,forEach:function(D,Y,at){Z(D,function(){Y.apply(this,arguments)},at)},count:function(D){var Y=0;return Z(D,function(){Y++}),Y},toArray:function(D){return Z(D,function(Y){return Y})||[]},only:function(D){if(!S(D))throw Error("React.Children.only expected to receive a single React element child.");return D}},Rt.Component=F,Rt.Fragment=n,Rt.Profiler=o,Rt.PureComponent=ut,Rt.StrictMode=s,Rt.Suspense=p,Rt.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=mt,Rt.act=function(){throw Error("act(...) is not supported in production builds of React.")},Rt.cache=function(D){return function(){return D.apply(null,arguments)}},Rt.cloneElement=function(D,Y,at){if(D==null)throw Error("The argument must be a React element, but you passed "+D+".");var nt=Q({},D.props),it=D.key,vt=void 0;if(Y!=null)for(Tt in Y.ref!==void 0&&(vt=void 0),Y.key!==void 0&&(it=""+Y.key),Y)!Ot.call(Y,Tt)||Tt==="key"||Tt==="__self"||Tt==="__source"||Tt==="ref"&&Y.ref===void 0||(nt[Tt]=Y[Tt]);var Tt=arguments.length-2;if(Tt===1)nt.children=at;else if(1<Tt){for(var de=Array(Tt),qt=0;qt<Tt;qt++)de[qt]=arguments[qt+2];nt.children=de}return M(D.type,it,void 0,void 0,vt,nt)},Rt.createContext=function(D){return D={$$typeof:f,_currentValue:D,_currentValue2:D,_threadCount:0,Provider:null,Consumer:null},D.Provider=D,D.Consumer={$$typeof:u,_context:D},D},Rt.createElement=function(D,Y,at){var nt,it={},vt=null;if(Y!=null)for(nt in Y.key!==void 0&&(vt=""+Y.key),Y)Ot.call(Y,nt)&&nt!=="key"&&nt!=="__self"&&nt!=="__source"&&(it[nt]=Y[nt]);var Tt=arguments.length-2;if(Tt===1)it.children=at;else if(1<Tt){for(var de=Array(Tt),qt=0;qt<Tt;qt++)de[qt]=arguments[qt+2];it.children=de}if(D&&D.defaultProps)for(nt in Tt=D.defaultProps,Tt)it[nt]===void 0&&(it[nt]=Tt[nt]);return M(D,vt,void 0,void 0,null,it)},Rt.createRef=function(){return{current:null}},Rt.forwardRef=function(D){return{$$typeof:m,render:D}},Rt.isValidElement=S,Rt.lazy=function(D){return{$$typeof:E,_payload:{_status:-1,_result:D},_init:ct}},Rt.memo=function(D,Y){return{$$typeof:y,type:D,compare:Y===void 0?null:Y}},Rt.startTransition=function(D){var Y=mt.T,at={};mt.T=at;try{var nt=D(),it=mt.S;it!==null&&it(at,nt),typeof nt=="object"&&nt!==null&&typeof nt.then=="function"&&nt.then(It,st)}catch(vt){st(vt)}finally{mt.T=Y}},Rt.unstable_useCacheRefresh=function(){return mt.H.useCacheRefresh()},Rt.use=function(D){return mt.H.use(D)},Rt.useActionState=function(D,Y,at){return mt.H.useActionState(D,Y,at)},Rt.useCallback=function(D,Y){return mt.H.useCallback(D,Y)},Rt.useContext=function(D){return mt.H.useContext(D)},Rt.useDebugValue=function(){},Rt.useDeferredValue=function(D,Y){return mt.H.useDeferredValue(D,Y)},Rt.useEffect=function(D,Y){return mt.H.useEffect(D,Y)},Rt.useId=function(){return mt.H.useId()},Rt.useImperativeHandle=function(D,Y,at){return mt.H.useImperativeHandle(D,Y,at)},Rt.useInsertionEffect=function(D,Y){return mt.H.useInsertionEffect(D,Y)},Rt.useLayoutEffect=function(D,Y){return mt.H.useLayoutEffect(D,Y)},Rt.useMemo=function(D,Y){return mt.H.useMemo(D,Y)},Rt.useOptimistic=function(D,Y){return mt.H.useOptimistic(D,Y)},Rt.useReducer=function(D,Y,at){return mt.H.useReducer(D,Y,at)},Rt.useRef=function(D){return mt.H.useRef(D)},Rt.useState=function(D){return mt.H.useState(D)},Rt.useSyncExternalStore=function(D,Y,at){return mt.H.useSyncExternalStore(D,Y,at)},Rt.useTransition=function(){return mt.H.useTransition()},Rt.version="19.0.0",Rt}var fv;function pm(){return fv||(fv=1,md.exports=ES()),md.exports}var W=pm();const TS=yS(W),AS=pS({__proto__:null,default:TS},[W]);var gd={exports:{}},ml={},pd={exports:{}},yd={};/**
 * @license React
 ...
 *
 * @license MIT
 */function wl(){return wl=Object.assign?Object.assign.bind():function(r){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var s in n)Object.prototype.hasOwnProperty.call(n,s)&&(r[s]=n[s])}return r},wl.apply(this,arguments)}const vm=W.createContext(null),eb=W.createContext(null),Bs=W.createContext(null),Kc=W.createContext(null),js=W.createContext({outlet:null,matches:[],isDataRoute:!1}),p0=W.createContext(null);function nb(r,t){let{relative:n}=t===void 0?{}:t;xl()||ve(!1);let{basename:s,navigator:o}=W.useContext(Bs),{hash:u,pathname:f,search:m}=v0(r,{relative:n}),p=f;return s!=="/"&&(p=f==="/"?s:Br([s,f])),o.createHref({pathname:p,search:m,hash:u})}function xl(){return W.useContext(Kc)!=null}function Qc(){return xl()||ve(!1),W.useContext(Kc).location}function y0(r){W.useContext(Bs).static||W.useLayoutEffect(r)}function ib(){let{isDataRoute:r}=W.useContext(js);return r?pb():rb()}function rb(){xl()||ve(!1);let r=W.useContext(vm),{basename:t,future:n,navigator:s}=W.useContext(Bs),{matches:o}=W.useContext(js),{pathname:u}=Qc(),f=JSON.stringify(d0(o,n.v7_relativeSplatPath)),m=W.useRef(!1);return y0(()=>{m.current=!0}),W.useCallback(function(y,E){if(E===void 0&&(E={}),!m.current)return;if(typeof y=="number"){s.go(y);return}let b=m0(y,JSON.parse(f),u,E.relative==="path");r==null&&t!=="/"&&(b.pathname=b.pathname==="/"?t:Br([t,b.pathname])),(E.replace?s.replace:s.push)(b,E.state,E)},[t,s,f,u,r])}function v0(r,t){let{relative:n}=t===void 0?{}:t,{future:s}=W.useContext(Bs),{matches:o}=W.useContext(js),{pathname:u}=Qc(),f=JSON.stringify(d0(o,s.v7_relativeSplatPath));return W.useMemo(()=>m0(r,JSON.parse(f),u,n==="path"),[r,f,u,n])}function sb(r,t){return ab(r,t)}function ab(r,t,n,s){xl()||ve(!1);let{navigator:o,static:u}=W.useContext(Bs),{matches:f}=W.useContext(js),m=f[f.length-1],p=m?m.params:{};m&&m.pathname;let y=m?m.pathnameBase:"/";m&&m.route;let E=Qc(),b;if(t){var V;let rt=typeof t=="string"?to(t):t;y==="/"||(V=rt.pathname)!=null&&V.startsWith(y)||ve(!1),b=rt}else b=E;let B=b.pathname||"/",Q=B;if(y!=="/"){let rt=y.replace(/^\//,"").split("/");Q="/"+B.replace(/^\//,"").split("/").slice(rt.length).join("/")}let X=MS(r,{pathname:Q}),F=hb(X&&X.map(rt=>Object.assign({},rt,{params:Object.assign({},p,rt.params),pathname:Br([y,o.encodeLocation?o.encodeLocation(rt.pathname).pathname:rt.pathname]),pathnameBase:rt.pathnameBase==="/"?y:Br([y,o.encodeLocation?o.encodeLocation(rt.pathnameBase).pathname:rt.pathnameBase])})),f,n,s);return t&&F?W.createElement(Kc.Provider,{value:{location:wl({pathname:"/",search:"",hash:"",state:null,key:"default"},b),navigationType:Lr.Pop}},F):F}function ob(){let r=gb(),t=WS(r)?r.status+" "+r.statusText:r instanceof Error?r.message:JSON.stringify(r),n=r instanceof Error?r.stack:null,o={padding:"0.5rem",backgroundColor:"rgba(200,200,200, 0.5)"};return W.createElement(W.Fragment,null,W.createElement("h2",null,"Unexpected Application Error!"),W.createElement("h3",{style:{fontStyle:"italic"}},t),n?W.createElement("pre",{style:o},n):null,null)}const lb=W.createElement(ob,null);class ub extends W.Component{constructor(t){super(t),this.state={location:t.location,revalidation:t.revalidation,error:t.error}}static getDerivedStateFromError(t){return{error:t}}static getDerivedStateFromProps(t,n){return n.location!==t.location||n.revalidation!=="idle"&&t.revalidation==="idle"?{error:t.error,location:t.location,revalidation:t.revalidation}:{error:t.error!==void 0?t.error:n.error,location:n.location,revalidation:t.revalidation||n.revalidation}}componentDidCatch(t,n){console.error("React Router caught the following error during render",t,n)}render(){return this.state.error!==void 0?W.createElement(js.Provider,{value:this.props.routeContext},W.createElement(p0.Provider,{value:this.state.error,children:this.props.component})):this.props.children}}function cb(r){let{routeContext:t,match:n,children:s}=r,o=W.useContext(vm);return o&&o.static&&o.staticContext&&(n.route.errorElement||n.route.ErrorBoundary)&&(o.staticContext._deepestRenderedBoundaryId=n.route.id),W.createElement(js.Provider,{value:t},s)}function hb(r,t,n,s){var o;if(t===void 0&&(t=[]),n===void 0&&(n=null),s===void 0&&(s=null),r==null){var u;if(!n)return null;if(n.errors)r=n.matches;else if((u=s)!=null&&u.v7_partialHydration&&t.length===0&&!n.initialized&&n.matches.length>0)r=n.matches;else return null}let f=r,m=(o=n)==null?void 0:o.errors;if(m!=null){let E=f.findIndex(b=>b.route.id&&(m==null?void 0:m[b.route.id])!==void 0);E>=0||ve(!1),f=f.slice(0,Math.min(f.length,E+1))}let p=!1,y=-1;if(n&&s&&s.v7_partialHydration)for(let E=0;E<f.length;E++){let b=f[E];if((b.route.HydrateFallback||b.route.hydrateFallbackElement)&&(y=E),b.route.id){let{loaderData:V,errors:B}=n,Q=b.route.loader&&V[b.route.id]===void 0&&(!B||B[b.route.id]===void 0);if(b.route.lazy||Q){p=!0,y>=0?f=f.slice(0,y+1):f=[f[0]];break}}}return f.reduceRight((E,b,V)=>{let B,Q=!1,X=null,F=null;n&&(B=m&&b.route.id?m[b.route.id]:void 0,X=b.route.errorElement||lb,p&&(y<0&&V===0?(yb("route-fallback"),Q=!0,F=null):y===V&&(Q=!0,F=b.route.hydrateFallbackElement||null)));let rt=t.concat(f.slice(0,V+1)),ut=()=>{let ht;return B?ht=X:Q?ht=F:b.route.Component?ht=W.createElement(b.route.Component,null):b.route.element?ht=b.route.element:ht=E,W.createElement(cb,{match:b,routeContext:{outlet:E,matches:rt,isDataRoute:n!=null},children:ht})};return n&&(b.route.ErrorBoundary||b.route.errorElement||V===0)?W.createElement(ub,{location:n.location,revalidation:n.revalidation,component:X,error:B,children:ut(),routeContext:{outlet:null,matches:rt,isDataRoute:!0}}):ut()},null)}var _0=function(r){return r.UseBlocker="useBlocker",r.UseRevalidator="useRevalidator",r.UseNavigateStable="useNavigate",r}(_0||{}),E0=function(r){return r.UseBlocker="useBlocker",r.UseLoaderData="useLoaderData",r.UseActionData="useActionData",r.UseRouteError="useRouteError",r.UseNavigation="useNavigation",r.UseRouteLoaderData="useRouteLoaderData",r.UseMatches="useMatches",r.UseRevalidator="useRevalidator",r.UseNavigateStable="useNavigate",r.UseRouteId="useRouteId",r}(E0||{});function fb(r){let t=W.useContext(vm);return t||ve(!1),t}function db(r){let t=W.useContext(eb);return t||ve(!1),t}function mb(r){let t=W.useContext(js);return t||ve(!1),t}function T0(r){let t=mb(),n=t.matches[t.matches.length-1];return n.route.id||ve(!1),n.route.id}function gb(){var r;let t=W.useContext(p0),n=db(),s=T0();return t!==void 0?t:(r=n.errors)==null?void 0:r[s]}function pb(){let{router:r}=fb(_0.UseNavigateStable),t=T0(E0.UseNavigateStable),n=W.useRef(!1);return y0(()=>{n.current=!0}),W.useCallback(function(o,u){u===void 0&&(u={}),n.current&&(typeof o=="number"?r.navigate(o):r.navigate(o,wl({fromRouteId:t},u)))},[r,t])}const Sv={};function yb(r,t,n){Sv[r]||(Sv[r]=!0)}function vb(r,t){r==null||r.v7_startTransition,r==null||r.v7_relativeSplatPath}function zd(r){ve(!1)}function _b(r){let{basename:t="/",children:n=null,location:s,navigationType:o=Lr.Pop,navigator:u,static:f=!1,future:m}=r;xl()&&ve(!1);let p=t.replace(/^\/*/,"/"),y=W.useMemo(()=>({basename:p,navigator:u,static:f,future:wl({v7_relativeSplatPath:!1},m)}),[p,m,u,f]);typeof s=="string"&&(s=to(s));let{pathname:E="/",search:b="",hash:V="",state:B=null,key:Q="default"}=s,X=W.useMemo(()=>{let F=ym(E,p);return F==null?null:{location:{pathname:F,search:b,hash:V,state:B,key:Q},navigationType:o}},[p,E,b,V,B,Q,o]);return X==null?null:W.createElement(Bs.Provider,{value:y},W.createElement(Kc.Provider,{children:n,value:X}))}function Eb(r){let{children:t,location:n}=r;return sb(Bd(t),n)}new Promise(()=>{});function Bd(r,t){t===void 0&&(t=[]);let n=[];return W.Children.forEach(r,(s,o)=>{if(!W.isValidElement(s))return;let u=[...t,o];if(s.type===W.Fragment){n.push.apply(n,Bd(s.props.children,u));return}s.type!==zd&&ve(!1),!s.props.index||!s.props.children||ve(!1);let f={id:s.props.id||u.join("-"),caseSensitive:s.props.caseSensitive,element:s.props.element,Component:s.props.Component,index:s.props.index,path:s.props.path,loader:s.props.loader,action:s.props.action,errorElement:s.props.errorElement,ErrorBoundary:s.props.ErrorBoundary,hasErrorBoundary:s.props.ErrorBoundary!=null||s.props.errorElement!=null,shouldRevalidate:s.props.shouldRevalidate,handle:s.props.handle,lazy:s.props.lazy};s.props.children&&(f.children=Bd(s.props.children,u)),n.push(f)}),n}/**
 ...
 *
 * @license MIT
 */function jd(){return jd=Object.assign?Object.assign.bind():function(r){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var s in n)Object.prototype.hasOwnProperty.call(n,s)&&(r[s]=n[s])}return r},jd.apply(this,arguments)}function Tb(r,t){if(r==null)return{};var n={},s=Object.keys(r),o,u;for(u=0;u<s.length;u++)o=s[u],!(t.indexOf(o)>=0)&&(n[o]=r[o]);return n}function Ab(r){return!!(r.metaKey||r.altKey||r.ctrlKey||r.shiftKey)}function Sb(r,t){return r.button===0&&(!t||t==="_self")&&!Ab(r)}const bb=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset","viewTransition"],wb="6";try{window.__reactRouterVersion=wb}catch{}const Rb="startTransition",bv=AS[Rb];function Ib(r){let{basename:t,children:n,future:s,window:o}=r,u=W.useRef();u.current==null&&(u.current=DS({window:o,v5Compat:!0}));let f=u.current,[m,p]=W.useState({action:f.action,location:f.location}),{v7_startTransition:y}=s||{},E=W.useCallback(b=>{y&&bv?bv(()=>p(b)):p(b)},[p,y]);return W.useLayoutEffect(()=>f.listen(E),[f,E]),W.useEffect(()=>vb(s),[s]),W.createElement(_b,{basename:t,children:n,location:m.location,navigationType:m.action,navigator:f,future:s})}const Cb=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",Db=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Ob=W.forwardRef(function(t,n){let{onClick:s,relative:o,reloadDocument:u,replace:f,state:m,target:p,to:y,preventScrollReset:E,viewTransition:b}=t,V=Tb(t,bb),{basename:B}=W.useContext(Bs),Q,X=!1;if(typeof y=="string"&&Db.test(y)&&(Q=y,Cb))try{let ht=new URL(window.location.href),bt=y.startsWith("//")?new URL(ht.protocol+y):new URL(y),mt=ym(bt.pathname,B);bt.origin===ht.origin&&mt!=null?y=mt+bt.search+bt.hash:X=!0}catch{}let F=nb(y,{relative:o}),rt=Nb(y,{replace:f,state:m,target:p,preventScrollReset:E,relative:o,viewTransition:b});function ut(ht){s&&s(ht),ht.defaultPrevented||rt(ht)}return W.createElement("a",jd({},V,{href:Q||F,onClick:X||u?s:ut,ref:n,target:p}))});var wv;(function(r){r.UseScrollRestoration="useScrollRestoration",r.UseSubmit="useSubmit",r.UseSubmitFetcher="useSubmitFetcher",r.UseFetcher="useFetcher",r.useViewTransitionState="useViewTransitionState"})(wv||(wv={}));var Rv;(function(r){r.UseFetcher="useFetcher",r.UseFetchers="useFetchers",r.UseScrollRestoration="useScrollRestoration"})(Rv||(Rv={}));function Nb(r,t){let{target:n,replace:s,state:o,preventScrollReset:u,relative:f,viewTransition:m}=t===void 0?{}:t,p=ib(),y=Qc(),E=v0(r,{relative:f});return W.useCallback(b=>{if(Sb(b,n)){b.preventDefault();let V=s!==void 0?s:Rc(y)===Rc(E);p(r,{replace:V,state:o,preventScrollReset:u,relative:f,viewTransition:m})}},[y,p,E,s,o,n,r,u,f,m])}var Iv={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ub=()=>kb().__FIREBASE_DEFAULTS__,Lb=()=>{if(typeof process>"u"||typeof Iv>"u")return;const r=Iv.__FIREBASE_DEFAULTS__;if(r)return JSON.parse(r)},Pb=()=>{if(typeof document>"u")return;let r;try{r=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const t=r&&b0(r[1]);return t&&JSON.parse(t)},Yc=()=>{try{return Ub()||Lb()||Pb()}catch(r){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${r}`);return}},w0=r=>{var t,n;return(n=(t=Yc())===null||t===void 0?void 0:t.emulatorHosts)===null||n===void 0?void 0:n[r]},R0=r=>{const t=w0(r);if(!t)return;const n=t.lastIndexOf(":");if(n<=0||n+1===t.length)throw new Error(`Invalid host ${t} with no separate hostname and port!`);const s=parseInt(t.substring(n+1),10);return t[0]==="["?[t.substring(1,n-1),s]:[t.substring(0,n),s]},I0=()=>{var r;return(r=Yc())===null||r===void 0?void 0:r.config},C0=r=>{var t;return(t=Yc())===null||t===void 0?void 0:t[`_${r}`]};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tw=1e3,ew=2,nw=4*60*60*1e3,iw=.5;function Dv(r,t=tw,n=ew){const s=t*Math.pow(n,r),o=Math.round(iw*s*(Math.random()-.5)*2);return Math.min(nw,s+o)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Aw{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Sw(n)){const s=n.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(n=>n).join(" ")}}function Sw(r){const t=r.getComponent();return(t==null?void 0:t.type)==="VERSION"}const Fd="@firebase/app",xv="0.11.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const eo=Xw;function x0(r,t={}){let n=r;typeof t!="object"&&(t={name:t});const s=Object.assign({name:Gd,automaticDataCollectionEnabled:!1},t),o=s.name;if(typeof o!="string"||!o)throw qr.create("bad-app-name",{appName:String(o)});if(n||(n=I0()),!n)throw qr.create("no-options");const u=Cc.get(o);if(u){if(Rl(n,u.options)&&Rl(s,u.config))return u;throw qr.create("duplicate-app",{appName:o})}const f=new ow(o);for(const p of Kd.values())f.addComponent(p);const m=new tR(n,s,f);return Cc.set(o,m),m}function Xc(r=Gd){const t=Cc.get(r);if(!t&&r===Gd&&I0())return x0();if(!t)throw qr.create("no-app",{appName:r});return t}function on(r,t,n){var s;let o=(s=Zw[r])!==null&&s!==void 0?s:r;n&&(o+=`-${n}`);const u=o.match(/\s|\//),f=t.match(/\s|\//);if(u||f){const m=[`Unable to register library "${o}" with version "${t}":`];u&&m.push(`library name "${o}" contains illegal characters (whitespace or "/")`),u&&f&&m.push("and"),f&&m.push(`version name "${t}" contains illegal characters (whitespace or "/")`),Qi.warn(m.join(" "));return}Kn(new Ln(`${o}-version`,()=>({library:o,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cR(r){Kn(new Ln("platform-logger",t=>new Aw(t),"PRIVATE")),Kn(new Ln("heartbeat",t=>new aR(t),"PRIVATE")),on(Fd,xv,r),on(Fd,xv,"esm2017"),on("fire-js","")}cR("");var Pv=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const RR=-1;function Wc(r){return r==null}function Yd(r){return r===0&&1/r==-1/0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const H0="";function IR(r){let t="";for(let n=0;n<r.length;n++)t.length>0&&(t=Gv(t)),t=CR(r.get(n),t);return Gv(t)}function CR(r,t){let n=t;const s=r.length;for(let o=0;o<s;o++){const u=r.charAt(o);switch(u){case"\0":n+="";break;case H0:n+="";break;default:n+=u}}return n}function Gv(r){return r+H0+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kv(r){let t=0;for(const n in r)Object.prototype.hasOwnProperty.call(r,n)&&t++;return t}function kl(r,t){for(const n in r)Object.prototype.hasOwnProperty.call(r,n)&&t(n,r[n])}function DR(r){for(const t in r)if(Object.prototype.hasOwnProperty.call(r,t))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Oc{constructor(t,n){this.position=t,this.inclusive=n}}function Jv(r,t,n){let s=0;for(let o=0;o<r.position.length;o++){const u=t[o],f=r.position[o];if(u.field.isKeyField()?s=yt.comparator(yt.fromName(f.referenceValue),n.key):s=Qa(f,n.data.field(u.field)),u.dir==="desc"&&(s*=-1),s!==0)break}return s}function Wv(r,t){if(r===null)return t===null;if(t===null||r.inclusive!==t.inclusive||r.position.length!==t.position.length)return!1;for(let n=0;n<r.position.length;n++)if(!di(r.position[n],t.position[n]))return!1;return!0}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const JR=new fe(yt.comparator);function Yr(){return JR}const rE=new fe(yt.comparator);function pl(...r){let t=rE;for(const n of r)t=t.insert(n.key,n);return t}function WR(r){let t=rE;return r.forEach((n,s)=>t=t.insert(n,s.overlayedDocument)),t}function Os(){return El()}function sE(){return El()}function El(){return new Hs(r=>r.toString(),(r,t)=>r.isEqual(t))}const t1=new Re(yt.comparator);function jt(...r){let t=t1;for(const n of r)t=t.add(n);return t}const e1=new Re(zt);function n1(){return e1}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function i1(r,t){if(r.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Yd(t)?"-0":t}}function r1(r){return{integerValue:""+r}}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rh{constructor(){this._=void 0}}function s1(r,t,n){return r instanceof em?function(o,u){const f={fields:{[K0]:{stringValue:G0},[Y0]:{timestampValue:{seconds:o.seconds,nanos:o.nanoseconds}}}};return u&&bm(u)&&(u=th(u)),u&&(f.fields[Q0]=u),{mapValue:f}}(n,t):r instanceof Mc?aE(r,t):r instanceof xc?oE(r,t):function(o,u){const f=o1(o,u),m=n_(f)+n_(o.Ie);return Zd(f)&&Zd(o.Ie)?r1(m):i1(o.serializer,m)}(r,t)}function a1(r,t,n){return r instanceof Mc?aE(r,t):r instanceof xc?oE(r,t):n}function o1(r,t){return r instanceof nm?function(s){return Zd(s)||function(u){return!!u&&"doubleValue"in u}(s)}(t)?t:{integerValue:0}:null}class em extends rh{}class Mc extends rh{constructor(t){super(),this.elements=t}}function aE(r,t){const n=lE(t);for(const s of r.elements)n.some(o=>di(o,s))||n.push(s);return{arrayValue:{values:n}}}class xc extends rh{constructor(t){super(),this.elements=t}}function oE(r,t){let n=lE(t);for(const s of r.elements)n=n.filter(o=>!di(o,s));return{arrayValue:{values:n}}}class nm extends rh{constructor(t,n){super(),this.serializer=t,this.Ie=n}}function n_(r){return he(r.integerValue||r.doubleValue)}function lE(r){return wm(r)&&r.arrayValue.values?r.arrayValue.values.slice():[]}function l1(r,t){return r.field.isEqual(t.field)&&function(s,o){return s instanceof Mc&&o instanceof Mc||s instanceof xc&&o instanceof xc?Ka(s.elements,o.elements,di):s instanceof nm&&o instanceof nm?di(s.Ie,o.Ie):s instanceof em&&o instanceof em}(r.transform,t.transform)}class Vs{constructor(t,n){this.updateTime=t,this.exists=n}static none(){return new Vs}static exists(t){return new Vs(void 0,t)}static updateTime(t){return new Vs(t)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(t){return this.exists===t.exists&&(this.updateTime?!!t.updateTime&&this.updateTime.isEqual(t.updateTime):!t.updateTime)}}function vc(r,t){return r.updateTime!==void 0?t.isFoundDocument()&&t.version.isEqual(r.updateTime):r.exists===void 0||r.exists===t.isFoundDocument()}class Cm{}function uE(r,t){if(!r.hasLocalMutations||t&&t.fields.length===0)return null;if(t===null)return r.isNoDocument()?new c1(r.key,Vs.none()):new Dm(r.key,r.data,Vs.none());{const n=r.data,s=ci.empty();let o=new Re(tn.comparator);for(let u of t.fields)if(!o.has(u)){let f=n.field(u);f===null&&u.length>1&&(u=u.popLast(),f=n.field(u)),f===null?s.delete(u):s.set(u,f),o=o.add(u)}return new sh(r.key,s,new Pr(o.toArray()),Vs.none())}}function u1(r,t,n){r instanceof Dm?function(o,u,f){const m=o.value.clone(),p=r_(o.fieldTransforms,u,f.transformResults);m.setAll(p),u.convertToFoundDocument(f.version,m).setHasCommittedMutations()}(r,t,n):r instanceof sh?function(o,u,f){if(!vc(o.precondition,u))return void u.convertToUnknownDocument(f.version);const m=r_(o.fieldTransforms,u,f.transformResults),p=u.data;p.setAll(cE(o)),p.setAll(m),u.convertToFoundDocument(f.version,p).setHasCommittedMutations()}(r,t,n):function(o,u,f){u.convertToNoDocument(f.version).setHasCommittedMutations()}(0,t,n)}function Tl(r,t,n,s){return r instanceof Dm?function(u,f,m,p){if(!vc(u.precondition,f))return m;const y=u.value.clone(),E=s_(u.fieldTransforms,p,f);return y.setAll(E),f.convertToFoundDocument(f.version,y).setHasLocalMutations(),null}(r,t,n,s):r instanceof sh?function(u,f,m,p){if(!vc(u.precondition,f))return m;const y=s_(u.fieldTransforms,p,f),E=f.data;return E.setAll(cE(u)),E.setAll(y),f.convertToFoundDocument(f.version,E).setHasLocalMutations(),m===null?null:m.unionWith(u.fieldMask.fields).unionWith(u.fieldTransforms.map(b=>b.field))}(r,t,n,s):function(u,f,m){return vc(u.precondition,f)?(f.convertToNoDocument(f.version).setHasLocalMutations(),null):m}(r,t,n)}function i_(r,t){return r.type===t.type&&!!r.key.isEqual(t.key)&&!!r.precondition.isEqual(t.precondition)&&!!function(s,o){return s===void 0&&o===void 0||!(!s||!o)&&Ka(s,o,(u,f)=>l1(u,f))}(r.fieldTransforms,t.fieldTransforms)&&(r.type===0?r.value.isEqual(t.value):r.type!==1||r.data.isEqual(t.data)&&r.fieldMask.isEqual(t.fieldMask))}class Dm extends Cm{constructor(t,n,s,o=[]){super(),this.key=t,this.value=n,this.precondition=s,this.fieldTransforms=o,this.type=0}getFieldMask(){return null}}class sh extends Cm{constructor(t,n,s,o,u=[]){super(),this.key=t,this.data=n,this.fieldMask=s,this.precondition=o,this.fieldTransforms=u,this.type=1}getFieldMask(){return this.fieldMask}}function cE(r){const t=new Map;return r.fieldMask.fields.forEach(n=>{if(!n.isEmpty()){const s=r.data.field(n);t.set(n,s)}}),t}function r_(r,t,n){const s=new Map;ne(r.length===n.length);for(let o=0;o<n.length;o++){const u=r[o],f=u.transform,m=t.data.field(u.field);s.set(u.field,a1(f,m,n[o]))}return s}function s_(r,t,n){const s=new Map;for(const o of r){const u=o.transform,f=n.data.field(o.field);s.set(o.field,s1(u,f,t))}return s}class c1 extends Cm{constructor(t,n){super(),this.key=t,this.precondition=n,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bE(r){return new E1(r,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wI{constructor(){this.ea=void 0,this.ta=[]}na(){return this.ta.some(t=>t.ra())}}class RI{constructor(){this.queries=A_(),this.onlineState="Unknown",this.ia=new Set}terminate(){(function(n,s){const o=Bt(n),u=o.queries;o.queries=A_(),u.forEach((f,m)=>{for(const p of m.ta)p.onError(s)})})(this,new pt(et.ABORTED,"Firestore shutting down"))}}function A_(){return new Hs(r=>nE(r),nh)}async function II(r,t){const n=Bt(r);let s=3;const o=t.query;let u=n.queries.get(o);u?!u.na()&&t.ra()&&(s=2):(u=new wI,s=t.ra()?0:1);try{switch(s){case 0:u.ea=await n.onListen(o,!0);break;case 1:u.ea=await n.onListen(o,!1);break;case 2:await n.onFirstRemoteStoreListen(o)}}catch(f){const m=DE(f,`Initialization of query '${Ua(t.query)}' failed`);return void t.onError(m)}n.queries.set(o,u),u.ta.push(t),t.sa(n.onlineState),u.ea&&t.oa(u.ea)&&Bm(n)}async function CI(r,t){const n=Bt(r),s=t.query;let o=3;const u=n.queries.get(s);if(u){const f=u.ta.indexOf(t);f>=0&&(u.ta.splice(f,1),u.ta.length===0?o=t.ra()?0:1:!u.na()&&t.ra()&&(o=2))}switch(o){case 0:return n.queries.delete(s),n.onUnlisten(s,!0);case 1:return n.queries.delete(s),n.onUnlisten(s,!1);case 2:return n.onLastRemoteStoreUnlisten(s);default:return}}function DI(r,t){const n=Bt(r);let s=!1;for(const o of t){const u=o.query,f=n.queries.get(u);if(f){for(const m of f.ta)m.oa(o)&&(s=!0);f.ea=o}}s&&Bm(n)}function OI(r,t,n){const s=Bt(r),o=s.queries.get(t);if(o)for(const u of o.ta)u.onError(n);s.queries.delete(t)}function Bm(r){r.ia.forEach(t=>{t.next()})}var om,S_;(S_=om||(om={}))._a="default",S_.Cache="cache";class NI{constructor(t,n,s){this.query=t,this.aa=n,this.ua=!1,this.ca=null,this.onlineState="Unknown",this.options=s||{}}oa(t){if(!this.options.includeMetadataChanges){const s=[];for(const o of t.docChanges)o.type!==3&&s.push(o);t=new Za(t.query,t.docs,t.oldDocs,s,t.mutatedKeys,t.fromCache,t.syncStateChanged,!0,t.hasCachedResults)}let n=!1;return this.ua?this.la(t)&&(this.aa.next(t),n=!0):this.ha(t,this.onlineState)&&(this.Pa(t),n=!0),this.ca=t,n}onError(t){this.aa.error(t)}sa(t){this.onlineState=t;let n=!1;return this.ca&&!this.ua&&this.ha(this.ca,t)&&(this.Pa(this.ca),n=!0),n}ha(t,n){if(!t.fromCache||!this.ra())return!0;const s=n!=="Offline";return(!this.options.Ta||!s)&&(!t.docs.isEmpty()||t.hasCachedResults||n==="Offline")}la(t){if(t.docChanges.length>0)return!0;const n=this.ca&&this.ca.hasPendingWrites!==t.hasPendingWrites;return!(!t.syncStateChanged&&!n)&&this.options.includeMetadataChanges===!0}Pa(t){t=Za.fromInitialDocuments(t.query,t.docs,t.mutatedKeys,t.fromCache,t.hasCachedResults),this.ua=!0,this.aa.next(t)}ra(){return this.options.source!==om.Cache}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class OE{constructor(t){this.key=t}}class NE{constructor(t){this.key=t}}class MI{constructor(t,n){this.query=t,this.fa=n,this.ga=null,this.hasCachedResults=!1,this.current=!1,this.pa=jt(),this.mutatedKeys=jt(),this.ya=iE(t),this.wa=new Ba(this.ya)}get Sa(){return this.fa}ba(t,n){const s=n?n.Da:new T_,o=n?n.wa:this.wa;let u=n?n.mutatedKeys:this.mutatedKeys,f=o,m=!1;const p=this.query.limitType==="F"&&o.size===this.query.limit?o.last():null,y=this.query.limitType==="L"&&o.size===this.query.limit?o.first():null;if(t.inorderTraversal((E,b)=>{const V=o.get(E),B=ih(this.query,b)?b:null,Q=!!V&&this.mutatedKeys.has(V.key),X=!!B&&(B.hasLocalMutations||this.mutatedKeys.has(B.key)&&B.hasCommittedMutations);let F=!1;V&&B?V.data.isEqual(B.data)?Q!==X&&(s.track({type:3,doc:B}),F=!0):this.va(V,B)||(s.track({type:2,doc:B}),F=!0,(p&&this.ya(B,p)>0||y&&this.ya(B,y)<0)&&(m=!0)):!V&&B?(s.track({type:0,doc:B}),F=!0):V&&!B&&(s.track({type:1,doc:V}),F=!0,(p||y)&&(m=!0)),F&&(B?(f=f.add(B),u=X?u.add(E):u.delete(E)):(f=f.delete(E),u=u.delete(E)))}),this.query.limit!==null)for(;f.size>this.query.limit;){const E=this.query.limitType==="F"?f.last():f.first();f=f.delete(E.key),u=u.delete(E.key),s.track({type:1,doc:E})}return{wa:f,Da:s,ls:m,mutatedKeys:u}}va(t,n){return t.hasLocalMutations&&n.hasCommittedMutations&&!n.hasLocalMutations}applyChanges(t,n,s,o){const u=this.wa;this.wa=t.wa,this.mutatedKeys=t.mutatedKeys;const f=t.Da.X_();f.sort((E,b)=>function(B,Q){const X=F=>{switch(F){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return wt()}};return X(B)-X(Q)}(E.type,b.type)||this.ya(E.doc,b.doc)),this.Ca(s),o=o!=null&&o;const m=n&&!o?this.Fa():[],p=this.pa.size===0&&this.current&&!o?1:0,y=p!==this.ga;return this.ga=p,f.length!==0||y?{snapshot:new Za(this.query,t.wa,u,f,t.mutatedKeys,p===0,y,!1,!!s&&s.resumeToken.approximateByteSize()>0),Ma:m}:{Ma:m}}sa(t){return this.current&&t==="Offline"?(this.current=!1,this.applyChanges({wa:this.wa,Da:new T_,mutatedKeys:this.mutatedKeys,ls:!1},!1)):{Ma:[]}}xa(t){return!this.fa.has(t)&&!!this.wa.has(t)&&!this.wa.get(t).hasLocalMutations}Ca(t){t&&(t.addedDocuments.forEach(n=>this.fa=this.fa.add(n)),t.modifiedDocuments.forEach(n=>{}),t.removedDocuments.forEach(n=>this.fa=this.fa.delete(n)),this.current=t.current)}Fa(){if(!this.current)return[];const t=this.pa;this.pa=jt(),this.wa.forEach(s=>{this.xa(s.key)&&(this.pa=this.pa.add(s.key))});const n=[];return t.forEach(s=>{this.pa.has(s)||n.push(new NE(s))}),this.pa.forEach(s=>{t.has(s)||n.push(new OE(s))}),n}Oa(t){this.fa=t.gs,this.pa=jt();const n=this.ba(t.documents);return this.applyChanges(n,!0)}Na(){return Za.fromInitialDocuments(this.query,this.wa,this.mutatedKeys,this.ga===0,this.hasCachedResults)}}const jm="SyncEngine";class xI{constructor(t,n,s){this.query=t,this.targetId=n,this.view=s}}class VI{constructor(t){this.key=t,this.Ba=!1}}class kI{constructor(t,n,s,o,u,f){this.localStore=t,this.remoteStore=n,this.eventManager=s,this.sharedClientState=o,this.currentUser=u,this.maxConcurrentLimboResolutions=f,this.La={},this.ka=new Hs(m=>nE(m),nh),this.qa=new Map,this.Qa=new Set,this.$a=new fe(yt.comparator),this.Ka=new Map,this.Ua=new Nm,this.Wa={},this.Ga=new Map,this.za=$a.Un(),this.onlineState="Unknown",this.ja=void 0}get isPrimaryClient(){return this.ja===!0}}async function UI(r,t,n=!0){const s=UE(r);let o;const u=s.ka.get(t);return u?(s.sharedClientState.addLocalQueryTarget(u.targetId),o=u.view.Na()):o=await ME(s,t,n,!0),o}async function LI(r,t){const n=UE(r);await ME(n,t,!0,!1)}async function ME(r,t,n,s){const o=await aI(r.localStore,hi(t)),u=o.targetId,f=r.sharedClientState.addLocalQueryTarget(u,n);let m;return s&&(m=await PI(r,t,u,f==="current",o.resumeToken)),r.isPrimaryClient&&n&&RE(r.remoteStore,o),m}async function PI(r,t,n,s,o){r.Ha=(b,V,B)=>async function(X,F,rt,ut){let ht=F.view.ba(rt);ht.ls&&(ht=await m_(X.localStore,F.query,!1).then(({documents:M})=>F.view.ba(M,ht)));const bt=ut&&ut.targetChanges.get(F.targetId),mt=ut&&ut.targetMismatches.get(F.targetId)!=null,Ot=F.view.applyChanges(ht,X.isPrimaryClient,bt,mt);return w_(X,F.targetId,Ot.Ma),Ot.snapshot}(r,b,V,B);const u=await m_(r.localStore,t,!0),f=new MI(t,u.gs),m=f.ba(u.documents),p=Ul.createSynthesizedTargetChangeForCurrentChange(n,s&&r.onlineState!=="Offline",o),y=f.applyChanges(m,r.isPrimaryClient,p);w_(r,n,y.Ma);const E=new xI(t,n,f);return r.ka.set(t,E),r.qa.has(n)?r.qa.get(n).push(t):r.qa.set(n,[t]),y.snapshot}async function zI(r,t,n){const s=Bt(r),o=s.ka.get(t),u=s.qa.get(o.targetId);if(u.length>1)return s.qa.set(o.targetId,u.filter(f=>!nh(f,t))),void s.ka.delete(t);s.isPrimaryClient?(s.sharedClientState.removeLocalQueryTarget(o.targetId),s.sharedClientState.isActiveQueryTarget(o.targetId)||await sm(s.localStore,o.targetId,!1).then(()=>{s.sharedClientState.clearQueryState(o.targetId),n&&km(s.remoteStore,o.targetId),lm(s,o.targetId)}).catch(Zc)):(lm(s,o.targetId),await sm(s.localStore,o.targetId,!0))}async function BI(r,t){const n=Bt(r),s=n.ka.get(t),o=n.qa.get(s.targetId);n.isPrimaryClient&&o.length===1&&(n.sharedClientState.removeLocalQueryTarget(s.targetId),km(n.remoteStore,s.targetId))}async function xE(r,t){const n=Bt(r);try{const s=await rI(n.localStore,t);t.targetChanges.forEach((o,u)=>{const f=n.Ka.get(u);f&&(ne(o.addedDocuments.size+o.modifiedDocuments.size+o.removedDocuments.size<=1),o.addedDocuments.size>0?f.Ba=!0:o.modifiedDocuments.size>0?ne(f.Ba):o.removedDocuments.size>0&&(ne(f.Ba),f.Ba=!1))}),await kE(n,s,t)}catch(s){await Zc(s)}}function b_(r,t,n){const s=Bt(r);if(s.isPrimaryClient&&n===0||!s.isPrimaryClient&&n===1){const o=[];s.ka.forEach((u,f)=>{const m=f.view.sa(t);m.snapshot&&o.push(m.snapshot)}),function(f,m){const p=Bt(f);p.onlineState=m;let y=!1;p.queries.forEach((E,b)=>{for(const V of b.ta)V.sa(m)&&(y=!0)}),y&&Bm(p)}(s.eventManager,t),o.length&&s.La.p_(o),s.onlineState=t,s.isPrimaryClient&&s.sharedClientState.setOnlineState(t)}}async function jI(r,t,n){const s=Bt(r);s.sharedClientState.updateQueryState(t,"rejected",n);const o=s.Ka.get(t),u=o&&o.key;if(u){let f=new fe(yt.comparator);f=f.insert(u,Ke.newNoDocument(u,St.min()));const m=jt().add(u),p=new ah(St.min(),new Map,new fe(zt),f,m);await xE(s,p),s.$a=s.$a.remove(u),s.Ka.delete(t),qm(s)}else await sm(s.localStore,t,!1).then(()=>lm(s,t,n)).catch(Zc)}function lm(r,t,n=null){r.sharedClientState.removeLocalQueryTarget(t);for(const s of r.qa.get(t))r.ka.delete(s),n&&r.La.Ja(s,n);r.qa.delete(t),r.isPrimaryClient&&r.Ua.br(t).forEach(s=>{r.Ua.containsKey(s)||VE(r,s)})}function VE(r,t){r.Qa.delete(t.path.canonicalString());const n=r.$a.get(t);n!==null&&(km(r.remoteStore,n),r.$a=r.$a.remove(t),r.Ka.delete(n),qm(r))}function w_(r,t,n){for(const s of n)s instanceof OE?(r.Ua.addReference(s.key,t),qI(r,s)):s instanceof NE?(ot(jm,"Document no longer in limbo: "+s.key),r.Ua.removeReference(s.key,t),r.Ua.containsKey(s.key)||VE(r,s.key)):wt()}function qI(r,t){const n=t.key,s=n.path.canonicalString();r.$a.get(n)||r.Qa.has(s)||(ot(jm,"New document in limbo: "+n),r.Qa.add(s),qm(r))}function qm(r){for(;r.Qa.size>0&&r.$a.size<r.maxConcurrentLimboResolutions;){const t=r.Qa.values().next().value;r.Qa.delete(t);const n=new yt(le.fromString(t)),s=r.za.next();r.Ka.set(s,new VI(n)),r.$a=r.$a.insert(n,s),RE(r.remoteStore,new zr(hi(eE(n.path)),s,"TargetPurposeLimboResolution",Jc.ae))}}async function kE(r,t,n){const s=Bt(r),o=[],u=[],f=[];s.ka.isEmpty()||(s.ka.forEach((m,p)=>{f.push(s.Ha(p,t,n).then(y=>{var E;if((y||n)&&s.isPrimaryClient){const b=y?!y.fromCache:(E=n==null?void 0:n.targetChanges.get(p.targetId))===null||E===void 0?void 0:E.current;s.sharedClientState.updateQueryState(p.targetId,b?"current":"not-current")}if(y){o.push(y);const b=xm.Yi(p.targetId,y);u.push(b)}}))}),await Promise.all(f),s.La.p_(o),await async function(p,y){const E=Bt(p);try{await E.persistence.runTransaction("notifyLocalViewChanges","readwrite",b=>K.forEach(y,V=>K.forEach(V.Hi,B=>E.persistence.referenceDelegate.addReference(b,V.targetId,B)).next(()=>K.forEach(V.Ji,B=>E.persistence.referenceDelegate.removeReference(b,V.targetId,B)))))}catch(b){if(!io(b))throw b;ot(Vm,"Failed to update sequence numbers: "+b)}for(const b of y){const V=b.targetId;if(!b.fromCache){const B=E.Ts.get(V),Q=B.snapshotVersion,X=B.withLastLimboFreeSnapshotVersion(Q);E.Ts=E.Ts.insert(V,X)}}}(s.localStore,u))}async function HI(r,t){const n=Bt(r);if(!n.currentUser.isEqual(t)){ot(jm,"User change. New user:",t.toKey());const s=await AE(n.localStore,t);n.currentUser=t,function(u,f){u.Ga.forEach(m=>{m.forEach(p=>{p.reject(new pt(et.CANCELLED,f))})}),u.Ga.clear()}(n,"'waitForPendingWrites' promise is rejected due to a user change."),n.sharedClientState.handleUserChange(t,s.removedBatchIds,s.addedBatchIds),await kE(n,s.Rs)}}function FI(r,t){const n=Bt(r),s=n.Ka.get(t);if(s&&s.Ba)return jt().add(s.key);{let o=jt();const u=n.qa.get(t);if(!u)return o;for(const f of u){const m=n.ka.get(f);o=o.unionWith(m.view.Sa)}return o}}function UE(r){const t=Bt(r);return t.remoteStore.remoteSyncer.applyRemoteEvent=xE.bind(null,t),t.remoteStore.remoteSyncer.getRemoteKeysForTarget=FI.bind(null,t),t.remoteStore.remoteSyncer.rejectListen=jI.bind(null,t),t.La.p_=DI.bind(null,t.eventManager),t.La.Ja=OI.bind(null,t.eventManager),t}class kc{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(t){this.serializer=bE(t.databaseInfo.databaseId),this.sharedClientState=this.Za(t),this.persistence=this.Xa(t),await this.persistence.start(),this.localStore=this.eu(t),this.gcScheduler=this.tu(t,this.localStore),this.indexBackfillerScheduler=this.nu(t,this.localStore)}tu(t,n){return null}nu(t,n){return null}eu(t){return iI(this.persistence,new tI,t.initialUser,this.serializer)}Xa(t){return new TE(Mm.ri,this.serializer)}Za(t){return new lI}async terminate(){var t,n;(t=this.gcScheduler)===null||t===void 0||t.stop(),(n=this.indexBackfillerScheduler)===null||n===void 0||n.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}kc.provider={build:()=>new kc};class GI extends kc{constructor(t){super(),this.cacheSizeBytes=t}tu(t,n){ne(this.persistence.referenceDelegate instanceof Vc);const s=this.persistence.referenceDelegate.garbageCollector;return new z1(s,t.asyncQueue,n)}Xa(t){const n=this.cacheSizeBytes!==void 0?sn.withCacheSize(this.cacheSizeBytes):sn.DEFAULT;return new TE(s=>Vc.ri(s,n),this.serializer)}}class um{async initialize(t,n){this.localStore||(this.localStore=t.localStore,this.sharedClientState=t.sharedClientState,this.datastore=this.createDatastore(n),this.remoteStore=this.createRemoteStore(n),this.eventManager=this.createEventManager(n),this.syncEngine=this.createSyncEngine(n,!t.synchronizeTabs),this.sharedClientState.onlineStateHandler=s=>b_(this.syncEngine,s,1),this.remoteStore.remoteSyncer.handleCredentialChange=HI.bind(null,this.syncEngine),await bI(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(t){return function(){return new RI}()}createDatastore(t){const n=bE(t.databaseInfo.databaseId),s=function(u){return new dI(u)}(t.databaseInfo);return function(u,f,m,p){return new yI(u,f,m,p)}(t.authCredentials,t.appCheckCredentials,s,n)}createRemoteStore(t){return function(s,o,u,f,m){return new _I(s,o,u,f,m)}(this.localStore,this.datastore,t.asyncQueue,n=>b_(this.syncEngine,n,0),function(){return y_.D()?new y_:new uI}())}createSyncEngine(t,n){return function(o,u,f,m,p,y,E){const b=new kI(o,u,f,m,p,y);return E&&(b.ja=!0),b}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,t.initialUser,t.maxConcurrentLimboResolutions,n)}async terminate(){var t,n;await async function(o){const u=Bt(o);ot(Xa,"RemoteStore shutting down."),u.W_.add(5),await Ll(u),u.z_.shutdown(),u.j_.set("Unknown")}(this.remoteStore),(t=this.datastore)===null||t===void 0||t.terminate(),(n=this.eventManager)===null||n===void 0||n.terminate()}}um.provider={build:()=>new um};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class BE{constructor(...t){for(let n=0;n<t.length;++n)if(t[n].length===0)throw new pt(et.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new tn(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class aC{constructor(t){this._values=(t||[]).map(n=>n)}toArray(){return this._values.map(t=>t)}isEqual(t){return function(s,o){if(s.length!==o.length)return!1;for(let u=0;u<s.length;++u)if(s[u]!==o[u])return!1;return!0}(this._values,t._values)}}const oC=new RegExp("[~\\*/\\[\\]]");function lC(r,t,n){if(t.search(oC)>=0)throw x_(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,r);try{return new BE(...t.split("."))._internalPath}catch{throw x_(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,r)}}function x_(r,t,n,s,o){let u=`Function ${t}() called with invalid data`;u+=". ";let f="";return new pt(et.INVALID_ARGUMENT,u+r+f)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */on(yC,vC,"app");const HE="@firebase/installations",Fm="0.6.12";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const FE=1e4,GE=`w:${Fm}`,KE="FIS_v2",_C="https://firebaseinstallations.googleapis.com/v1",EC=60*60*1e3,TC="installations",AC="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function IC({appConfig:r,heartbeatServiceProvider:t},{fid:n}){const s=YE(r),o=ZE(r),u=t.getImmediate({optional:!0});if(u){const y=await u.getHeartbeatsHeader();y&&o.append("x-firebase-client",y)}const f={fid:n,authVersion:KE,appId:r.appId,sdkVersion:GE},m={method:"POST",headers:o,body:JSON.stringify(f)},p=await JE(()=>fetch(s,m));if(p.ok){const y=await p.json();return{fid:y.fid||n,registrationStatus:2,refreshToken:y.refreshToken,authToken:$E(y.authToken)}}else throw await XE("Create Installation",p)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tT=new Map;function eT(r,t){const n=uh(r);nT(n,t),MC(n,t)}function nT(r,t){const n=tT.get(r);if(n)for(const s of n)s(t)}function MC(r,t){const n=xC();n&&n.postMessage({key:r,fid:t}),VC()}let Ns=null;function xC(){return!Ns&&"BroadcastChannel"in self&&(Ns=new BroadcastChannel("[Firebase] FID Change"),Ns.onmessage=r=>{nT(r.data.key,r.data.fid)}),Ns}function VC(){tT.size===0&&Ns&&(Ns.close(),Ns=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kC="firebase-installations-database",UC=1,Ps="firebase-installations-store";let Od=null;function Gm(){return Od||(Od=M0(kC,UC,{upgrade:(r,t)=>{switch(t){case 0:r.createObjectStore(Ps)}}})),Od}async function Lc(r,t){const n=uh(r),o=(await Gm()).transaction(Ps,"readwrite"),u=o.objectStore(Ps),f=await u.get(n);return await u.put(t,n),await o.done,(!f||f.fid!==t.fid)&&eT(r,t.fid),t}async function iT(r){const t=uh(r),s=(await Gm()).transaction(Ps,"readwrite");await s.objectStore(Ps).delete(t),await s.done}async function ch(r,t){const n=uh(r),o=(await Gm()).transaction(Ps,"readwrite"),u=o.objectStore(Ps),f=await u.get(n),m=t(f);return m===void 0?await u.delete(n):await u.put(m,n),await o.done,m&&(!f||f.fid!==m.fid)&&eT(r,m.fid),m}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qC({appConfig:r,heartbeatServiceProvider:t},n){const s=HC(r,n),o=bC(r,n),u=t.getImmediate({optional:!0});if(u){const y=await u.getHeartbeatsHeader();y&&o.append("x-firebase-client",y)}const f={installation:{sdkVersion:GE,appId:r.appId}},m={method:"POST",headers:o,body:JSON.stringify(f)},p=await JE(()=>fetch(s,m));if(p.ok){const y=await p.json();return $E(y)}else throw await XE("Generate Auth Token",p)}function HC(r,{fid:t}){return`${YE(r)}/${t}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function XC(r){const t=r,{installationEntry:n,registrationPromise:s}=await Km(t);return s?s.catch(console.error):Qm(t).catch(console.error),n.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ZC(r,t=!1){const n=r;return await JC(n),(await Qm(n,t)).token}async function JC(r){const{registrationPromise:t}=await Km(r);t&&await t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const aT="installations",tD="installations-internal",eD=r=>{const t=r.getProvider("app").getImmediate(),n=WC(t),s=Xr(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:s,_delete:()=>Promise.resolve()}},nD=r=>{const t=r.getProvider("app").getImmediate(),n=Xr(t,aT).getImmediate();return{getId:()=>XC(n),getToken:o=>ZC(n,o)}};function iD(){Kn(new Ln(aT,eD,"PUBLIC")),Kn(new Ln(tD,nD,"PRIVATE"))}iD();on(HE,Fm);on(HE,Fm,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pc="analytics",rD="firebase_id",sD="origin",aD=60*1e3,oD="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",Ym="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function uD(r){if(!r.startsWith(Ym)){const t=vn.create("invalid-gtag-resource",{gtagURL:r});return un.warn(t.message),""}return r}function oT(r){return Promise.all(r.map(t=>t.catch(n=>n)))}function cD(r,t){let n;return window.trustedTypes&&(n=window.trustedTypes.createPolicy(r,t)),n}function hD(r,t){const n=cD("firebase-js-sdk-policy",{createScriptURL:uD}),s=document.createElement("script"),o=`${Ym}?l=${r}&id=${t}`;s.src=n?n==null?void 0:n.createScriptURL(o):o,s.async=!0,document.head.appendChild(s)}function fD(r){let t=[];return Array.isArray(window[r])?t=window[r]:window[r]=t,t}async function dD(r,t,n,s,o,u){const f=s[o];try{if(f)await t[f];else{const p=(await oT(n)).find(y=>y.measurementId===o);p&&await t[p.appId]}}catch(m){un.error(m)}r("config",o,u)}async function mD(r,t,n,s,o){try{let u=[];if(o&&o.send_to){let f=o.send_to;Array.isArray(f)||(f=[f]);const m=await oT(n);for(const p of f){const y=m.find(b=>b.measurementId===p),E=y&&t[y.appId];if(E)u.push(E);else{u=[];break}}}u.length===0&&(u=Object.values(t)),await Promise.all(u),r("event",s,o||{})}catch(u){un.error(u)}}function gD(r,t,n,s){async function o(u,...f){try{if(u==="event"){const[m,p]=f;await mD(r,t,n,m,p)}else if(u==="config"){const[m,p]=f;await dD(r,t,n,s,m,p)}else if(u==="consent"){const[m,p]=f;r("consent",m,p)}else if(u==="get"){const[m,p,y]=f;r("get",m,p,y)}else if(u==="set"){const[m]=f;r("set",m)}else r(u,...f)}catch(m){un.error(m)}}return o}function pD(r,t,n,s,o){let u=function(...f){window[s].push(arguments)};return window[o]&&typeof window[o]=="function"&&(u=window[o]),window[o]=gD(u,r,t,n),{gtagCore:u,wrappedGtag:window[o]}}function yD(r){const t=window.document.getElementsByTagName("script");for(const n of Object.values(t))if(n.src&&n.src.includes(Ym)&&n.src.includes(r))return n;return null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class OD{constructor(t){this.app=t}_delete(){return delete Al[this.app.options.appId],Promise.resolve()}}let Al={},U_=[];const L_={};let Md="dataLayer",ND="gtag",P_,cT,z_=!1;function MD(){const r=[];if(_m()&&r.push("This is a browser extension environment."),D0()||r.push("Cookies are not available."),r.length>0){const t=r.map((s,o)=>`(${o+1}) ${s}`).join(" "),n=vn.create("invalid-analytics-context",{errorInfo:t});un.warn(n.message)}}function xD(r,t,n){MD();const s=r.options.appId;if(!s)throw vn.create("no-app-id");if(!r.options.apiKey)if(r.options.measurementId)un.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${r.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw vn.create("no-api-key");if(Al[s]!=null)throw vn.create("already-exists",{id:s});if(!z_){fD(Md);const{wrappedGtag:u,gtagCore:f}=pD(Al,U_,L_,Md,ND);cT=u,P_=f,z_=!0}return Al[s]=DD(r,U_,L_,t,P_,Md,n),new OD(r)}function VD(r=Xc()){r=cn(r);const t=Xr(r,Pc);return t.isInitialized()?t.getImmediate():kD(r)}function kD(r,t={}){const n=Xr(r,Pc);if(n.isInitialized()){const o=n.getImmediate();if(Rl(t,n.getOptions()))return o;throw vn.create("already-initialized")}return n.initialize({options:t})}async function UD(){if(_m()||!D0()||!Em())return!1;try{return await Tm()}catch{return!1}}function LD(r,t,n,s){r=cn(r),ID(cT,Al[r.app.options.appId],t,n,s).catch(o=>un.error(o))}const B_="@firebase/analytics",j_="0.10.11";function PD(){Kn(new Ln(Pc,(t,{options:n})=>{const s=t.getProvider("app").getImmediate(),o=t.getProvider("installations-internal").getImmediate();return xD(s,o,n)},"PUBLIC")),Kn(new Ln("analytics-internal",r,"PRIVATE")),on(B_,j_),on(B_,j_,"esm2017");function r(t){try{const n=t.getProvider(Pc).getImmediate();return{logEvent:(s,o,u)=>LD(n,s,o,u)}}catch(n){throw vn.create("interop-component-reg-failed",{reason:n})}}}PD();/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function r2(r=Xc(),t=fm){const s=Xr(cn(r),$m).getImmediate({identifier:t}),o=R0("functions");return o&&s2(s,...o),s}function s2(r,t,n){KD(cn(r),t,n)}function xd(r,t,n){return QD(cn(r),t)}i2();const a2={apiKey:"AIzaSyD5ALf922ZonYrURoAECZT_OWMPJwR1h8E",authDomain:"rankyale.firebaseapp.com",projectId:"rankyale",storageBucket:"rankyale.firebasestorage.app",messagingSenderId:"463872924342",appId:"1:463872924342:web:7266b4ff9f8b80eb73e417",measurementId:"G-L3PLKNTLJ1"},Xm=x0(a2),o2=nC(Xm),Vd=r2(Xm);typeof window<"u"&&UD().then(r=>r&&VD(Xm));const l2=async r=>{const t=eC(o2,"categories",r,"entries");try{return(await pC(t)).docs.map(s=>({id:s.id,...s.data()}))}catch(n){return console.error(`Error retrieving collection ${r}:`,n),[]}};function Zm(r,t){var n={};for(var s in r)Object.prototype.hasOwnProperty.call(r,s)&&t.indexOf(s)<0&&(n[s]=r[s]);if(r!=null&&typeof Object.getOwnPropertySymbols=="function")for(var o=0,s=Object.getOwnPropertySymbols(r);o<s.length;o++)t.indexOf(s[o])<0&&Object.prototype.propertyIsEnumerable.call(r,s[o])&&(n[s[o]]=r[s[o]]);return n}function dT(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const u2=dT,mT=new qs("auth","Firebase",dT());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dm(){var r;return typeof self<"u"&&((r=self.location)===null||r===void 0?void 0:r.href)||""}function f2(){return G_()==="http:"||G_()==="https:"}function G_(){var r;return typeof self<"u"&&((r=self.location)===null||r===void 0?void 0:r.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _2(r,t){return ao(r,"POST","/v1/accounts:delete",t)}async function vT(r,t){return ao(r,"POST","/v1/accounts:lookup",t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qc(r){var t;const n=r.auth,s=await r.getIdToken(),o=await Ml(r,vT(n,{idToken:s}));_t(o==null?void 0:o.users.length,n,"internal-error");const u=o.users[0];r._notifyReloadListener(u);const f=!((t=u.providerUserInfo)===null||t===void 0)&&t.length?_T(u.providerUserInfo):[],m=b2(r.providerData,f),p=r.isAnonymous,y=!(r.email&&u.passwordHash)&&!(m!=null&&m.length),E=p?y:!1,b={uid:u.localId,displayName:u.displayName||null,photoURL:u.photoUrl||null,email:u.email||null,emailVerified:u.emailVerified||!1,phoneNumber:u.phoneNumber||null,tenantId:u.tenantId||null,providerData:m,metadata:new mm(u.createdAt,u.lastLoginAt),isAnonymous:E};Object.assign(r,b)}async function S2(r){const t=cn(r);await qc(t),await t.auth._persistUserIfCurrent(t),t.auth._notifyListenersIfCurrent(t)}function b2(r,t){return[...r.filter(s=>!t.some(o=>o.providerId===s.providerId)),...t]}function _T(r){return r.map(t=>{var{providerId:n}=t,s=Zm(t,["providerId"]);return{providerId:n,uid:s.rawId||"",displayName:s.displayName||null,email:s.email||null,phoneNumber:s.phoneNumber||null,photoURL:s.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hc extends Pn{constructor(t,n,s,o){var u;super(n.code,n.message),this.operationType=s,this.user=o,Object.setPrototypeOf(this,Hc.prototype),this.customData={appName:t.name,tenantId:(u=t.tenantId)!==null&&u!==void 0?u:void 0,_serverResponse:n.customData._serverResponse,operationType:s}}static _fromErrorAndOperation(t,n,s,o){return new Hc(t,n,s,o)}}function MT(r,t,n,s){return(t==="reauthenticate"?n._getReauthenticationResolver(r):n._getIdTokenResponse(r)).catch(u=>{throw u.code==="auth/multi-factor-auth-required"?Hc._fromErrorAndOperation(r,u,t,s):u})}async function F2(r,t,n=!1){const s=await Ml(r,t._linkToIdToken(r.auth,await r.getIdToken()),n);return Wa._forOperation(r,"link",s)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xT{constructor(t,n){this.storageRetriever=t,this.type=n}_isAvailable(){try{return this.storage?(this.storage.setItem(Fc,"1"),this.storage.removeItem(Fc),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(t,n){return this.storage.setItem(t,JSON.stringify(n)),Promise.resolve()}_get(t){const n=this.storage.getItem(t);return Promise.resolve(n?JSON.parse(n):null)}_remove(t){return this.storage.removeItem(t),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pO="pendingRedirect",Sc=new Map;class yO extends qT{constructor(t,n,s=!1){super(t,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,s),this.eventId=null}async execute(){let t=Sc.get(this.auth._key());if(!t){try{const s=await vO(this.resolver,this.auth)?await super.execute():null;t=()=>Promise.resolve(s)}catch(n){t=()=>Promise.reject(n)}Sc.set(this.auth._key(),t)}return this.bypassAuthState||Sc.set(this.auth._key(),()=>Promise.resolve(null)),t()}async onAuthEvent(t){if(t.type==="signInViaRedirect")return super.onAuthEvent(t);if(t.type==="unknown"){this.resolve(null);return}if(t.eventId){const n=await this.auth._redirectUserForId(t.eventId);if(n)return this.user=n,super.onAuthEvent(t);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function vO(r,t){const n=TO(t),s=EO(r);if(!await s._isAvailable())return!1;const o=await s._get(n)==="true";return await s._remove(n),o}function _O(r,t){Sc.set(r._key(),t)}function EO(r){return Ki(r._redirectPersistence)}function TO(r){return Ac(pO,r.config.apiKey,r.name)}async function AO(r,t,n=!1){if(Un(r.app))return Promise.reject(ks(r));const s=hh(r),o=jT(s,t),f=await new yO(s,o,n).execute();return f&&!n&&(delete f.user._redirectEventId,await s._persistUserIfCurrent(f.user),await s._setRedirectUser(null,t)),f}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const SO=10*60*1e3;class bO{constructor(t){this.auth=t,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(t){this.consumers.add(t),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,t)&&(this.sendToConsumer(this.queuedRedirectEvent,t),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(t){this.consumers.delete(t)}onEvent(t){if(this.hasEventBeenHandled(t))return!1;let n=!1;return this.consumers.forEach(s=>{this.isEventForConsumer(t,s)&&(n=!0,this.sendToConsumer(t,s),this.saveEventToCache(t))}),this.hasHandledPotentialRedirect||!wO(t)||(this.hasHandledPotentialRedirect=!0,n||(this.queuedRedirectEvent=t,n=!0)),n}sendToConsumer(t,n){var s;if(t.error&&!HT(t)){const o=((s=t.error.code)===null||s===void 0?void 0:s.split("auth/")[1])||"internal-error";n.onError(Gn(this.auth,o))}else n.onAuthEvent(t)}isEventForConsumer(t,n){const s=n.eventId===null||!!t.eventId&&t.eventId===n.eventId;return n.filter.includes(t.type)&&s}hasEventBeenHandled(t){return Date.now()-this.lastProcessedEventTime>=SO&&this.cachedEventUids.clear(),this.cachedEventUids.has(e0(t))}saveEventToCache(t){this.cachedEventUids.add(e0(t)),this.lastProcessedEventTime=Date.now()}}function e0(r){return[r.type,r.eventId,r.sessionId,r.tenantId].filter(t=>t).join("-")}function HT({type:r,error:t}){return r==="unknown"&&(t==null?void 0:t.code)==="auth/no-auth-event"}function wO(r){switch(r.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return HT(r);default:return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const NO=new zl(3e4,6e4);function n0(){const r=fi().___jsl;if(r!=null&&r.H){for(const t of Object.keys(r.H))if(r.H[t].r=r.H[t].r||[],r.H[t].L=r.H[t].L||[],r.H[t].r=[...r.H[t].L],r.CP)for(let n=0;n<r.CP.length;n++)r.CP[n]=null}}function MO(r){return new Promise((t,n)=>{var s,o,u;function f(){n0(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{n0(),n(Gn(r,"network-request-failed"))},timeout:NO.get()})}if(!((o=(s=fi().gapi)===null||s===void 0?void 0:s.iframes)===null||o===void 0)&&o.Iframe)t(gapi.iframes.getContext());else if(!((u=fi().gapi)===null||u===void 0)&&u.load)f();else{const m=L2("iframefcb");return fi()[m]=()=>{gapi.load?f():n(Gn(r,"network-request-failed"))},k2(`${U2()}?onload=${m}`).catch(p=>n(p))}}).catch(t=>{throw bc=null,t})}let bc=null;function xO(r){return bc=bc||MO(r),bc}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jO={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},qO=500,HO=600,FO="_blank",GO="http://localhost";class i0{constructor(t){this.window=t,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function KO(r,t,n,s=qO,o=HO){const u=Math.max((window.screen.availHeight-o)/2,0).toString(),f=Math.max((window.screen.availWidth-s)/2,0).toString();let m="";const p=Object.assign(Object.assign({},jO),{width:s.toString(),height:o.toString(),top:u,left:f}),y=Qe().toLowerCase();n&&(m=ST(y)?FO:n),TT(y)&&(t=t||GO,p.scrollbars="yes");const E=Object.entries(p).reduce((V,[B,Q])=>`${V}${B}=${Q},`,"");if(I2(y)&&m!=="_self")return QO(t||"",m),new i0(null);const b=window.open(t||"",m,E);_t(b,r,"popup-blocked");try{b.focus()}catch{}return new i0(b)}function QO(r,t){const n=document.createElement("a");n.href=r,n.target=t;const s=document.createEvent("MouseEvent");s.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(s)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function eN(r){switch(r){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function nN(r){Kn(new Ln("auth",(t,{options:n})=>{const s=t.getProvider("app").getImmediate(),o=t.getProvider("heartbeat"),u=t.getProvider("app-check-internal"),{apiKey:f,authDomain:m}=s.options;_t(f&&!f.includes(":"),"invalid-api-key",{appName:s.name});const p={apiKey:f,authDomain:m,clientPlatform:r,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:DT(r)},y=new x2(s,o,u,p);return z2(y,n),y},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((t,n,s)=>{t.getProvider("auth-internal").initialize()})),Kn(new Ln("auth-internal",t=>{const n=hh(t.getProvider("auth").getImmediate());return(s=>new tN(s))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),on(s0,a0,eN(r)),on(s0,a0,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const iN=5*60,rN=C0("authIdTokenMaxAge")||iN;let o0=null;const sN=r=>async t=>{const n=t&&await t.getIdTokenResult(),s=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(s&&s>rN)return;const o=n==null?void 0:n.token;o0!==o&&(o0=o,await fetch(r,{method:o?"POST":"DELETE",headers:o?{Authorization:`Bearer ${o}`}:{}}))};function aN(r=Xc()){const t=Xr(r,"auth");if(t.isInitialized())return t.getImmediate();const n=P2(r,{popupRedirectResolver:WO,persistence:[cO,J2,UT]}),s=C0("authTokenSyncURL");if(s&&typeof isSecureContext=="boolean"&&isSecureContext){const u=new URL(s,location.origin);if(location.origin===u.origin){const f=sN(u.toString());Y2(n,f,()=>f(n.currentUser)),Q2(n,m=>f(m))}}const o=w0("auth");return o&&B2(n,`http://${o}`),n}function oN(){var r,t;return(t=(r=document.getElementsByTagName("head"))===null||r===void 0?void 0:r[0])!==null&&t!==void 0?t:document}V2({loadJS(r){return new Promise((t,n)=>{const s=document.createElement("script");s.setAttribute("src",r),s.onload=t,s.onerror=o=>{const u=Gn("internal-error");u.customData=o,n(u)},s.type="text/javascript",s.charset="UTF-8",oN().appendChild(s)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});nN("Browser");const l0=({entry:r,onClick:t})=>{const[n,s]=W.useState(!1),o=()=>{n||(s(!0),setTimeout(()=>{s(!1)},200),t())};return W.useEffect(()=>{if(r){const u=new Image;u.src=r.image?r.image==="assets/defaultStudent.avif"?"/defaultStudent.png":r.image:"/defaultStudent.png"}},[r]),r?tt.jsxs("div",{onClick:o,className:"flex flex-col flex-1 items-center rounded-lg hover:scale-105 transition duration-200 active:scale-100 cursor-pointer",children:[tt.jsxs("div",{className:"h-46 min-w-32 sm:h-60 sm:min-w-44 md:h-80 md:min-w-80 w-full flex items-center justify-center rounded-lg overflow-hidden mx-4 relative z-10",children:[tt.jsx("img",{src:r.image==="assets/defaultStudent.avif"?"/defaultStudent.png":r.image,alt:r.name,className:"object-contain h-full min-w-32 sm:min-w-44 md:min-w-60 rounded-lg",style:{display:r.image?"block":"none"}},r.image),!r.image&&tt.jsx("div",{className:"text-gray-400",children:"Loading..."})]}),tt.jsx("span",{className:`sm:mt-4 mt-2 font-semibold ${r.name.length>17?"text-sm sm:text-2xl":"text-base sm:text-2xl"}`,children:r.name})]}):null},lN=({pairs:r,currentPairIndex:t,entriesSubset:n,onVote:s,remainingVotes:o,valid:u,isPairsLoading:f})=>{var m,p;return W.useEffect(()=>{(E=>{var b,V,B,Q;if(E<r.length){const X=F=>{const rt=n[F];if(rt){const ut=new Image;ut.src=rt.image?rt.image==="assets/defaultStudent.avif"?"/defaultStudent.png":rt.image:"/defaultStudent.png"}};X((b=r[E])==null?void 0:b.entry1),X((V=r[E])==null?void 0:V.entry2),E+1<r.length&&(X((B=r[E+1])==null?void 0:B.entry1),X((Q=r[E+1])==null?void 0:Q.entry2))}})(t)},[t,r,n]),f&&n.length!==0?tt.jsx("div",{className:"w-16 h-16 border-4 border-blue-500 border-t-transparent rounded-full animate-spin my-24"}):r.length-t<=0?tt.jsx(tt.Fragment,{children:n.length!==0&&tt.jsx("div",{className:"sm:text-lg text-sm text-gray-600 flex flex-col items-center sm:my-6 my-4 sm:mb-8 mb-6",children:u?tt.jsx("div",{children:"Come back tomorrow for more rankings!"}):tt.jsx("div",{children:"You are unable to rank this category"})})}):tt.jsxs("div",{className:"sm:p-6 py-4 w-full text-center relative flex flex-col items-center",children:[tt.jsxs("div",{className:"flex justify-center flex-row sm:mx-8 sm:mb-6 mb-4",children:[tt.jsx(l0,{entry:n[(m=r[t-1])==null?void 0:m.entry1],onClick:()=>s(r[t-1],0)}),tt.jsx("div",{className:"sm:text-3xl text-xl font-semibold self-center",children:"or"}),tt.jsx(l0,{entry:n[(p=r[t-1])==null?void 0:p.entry2],onClick:()=>s(r[t-1],1)})]}),tt.jsx("button",{onClick:()=>s(r[t-1],2),className:"sm:px-12 px-8 sm:py-6 py-3 bg-white sm:text-2xl text-base font-semibold rounded-2xl hover:scale-105 active:scale-100 transition duration-200 shadow-lg",children:"I'm indifferent"}),tt.jsxs("div",{className:"text-gray-400 my-2 sm:text-base text-sm",children:[o-t+1," votes left today for this category"]})]})},FT=({handleLogout:r})=>tt.jsxs("div",{className:"flex items-center w-screen justify-between sm:p-6 p-4 sm:pr-10 z-10",children:[tt.jsx("div",{className:"text-3xl sm:text-4xl font-bold font-['Knewave'] tracking-wide cursor-pointer",onClick:()=>window.location.href="/",children:"RANKYALE"}),tt.jsxs("div",{className:"flex items-center gap-4 sm:gap-8 text-base sm:text-lg font-semibold",children:[tt.jsx(Ob,{to:"/about",className:"relative after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-0 after:bg-current after:transition-all after:duration-300 hover:after:w-full",children:"About"}),tt.jsx("a",{href:"https://forms.gle/Pqmeex4c6ubKRDAh8",target:"_blank",rel:"noopener noreferrer",className:"relative after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-0 after:bg-current after:transition-all after:duration-300 hover:after:w-full hidden sm:block",children:"Feedback"}),tt.jsx("button",{onClick:r,className:"relative after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-0 after:bg-current after:transition-all after:duration-300 hover:after:w-full text-red-600",children:"Sign Out"})]})]}),GT=()=>tt.jsx("div",{className:"w-full my-6 sm:my-10 text-center text-gray-500 sm:text-sm text-xs font-light tracking-wide",children:"An Addison Goolsbee production © 2025"}),wc=()=>tt.jsxs("div",{className:"fixed inset-0 z-0",children:[tt.jsx("div",{className:"orb",style:{width:"40vw",height:"40vw",minWidth:"300px",minHeight:"300px",top:"5%",left:"5%",animationDuration:"21s",animationDelay:"0.2s"}}),tt.jsx("div",{className:"orb top-[70%] left-[0%] sm:left-[35%] w-[40vw] h-[40vw] min-w-[250px] min-h-[250px]",style:{animationName:"float2",animationDuration:"26s",animationDelay:"1.1s"}}),tt.jsx("div",{className:"orb top-[35%] left-[70%] sm:top-[7%] w-[30vw] h-[30vw] min-w-[350px] min-h-[350px]",style:{animationName:"float3",animationDuration:"28s",animationDelay:"0.7s"}})]}),Va=aN(),uN={Freshmen:2028,Sophomores:2027,Juniors:2026,Seniors:2025};function cN(){const[r,t]=W.useState([]),[n,s]=W.useState([]),[o,u]=W.useState(null),[f,m]=W.useState(null),[p,y]=W.useState(!1),[E,b]=W.useState("All"),[V,B]=W.useState({All:[],Freshmen:[],Sophomores:[],Juniors:[],Seniors:[]}),[Q,X]=W.useState(!0),[F,rt]=W.useState({All:0,Freshmen:0,Sophomores:0,Juniors:0,Seniors:0}),[ut,ht]=W.useState({All:0,Freshmen:0,Sophomores:0,Juniors:0,Seniors:0}),[bt,mt]=W.useState(1),Ot=xd(Vd,"updateEloRating"),M=32,I=100;W.useEffect(()=>{const w=$2(Va,async Ct=>{var Et;(Et=Ct==null?void 0:Ct.email)!=null&&Et.endsWith("@yale.edu")?u(Ct):(Ct&&await Ud(Va),u(null)),y(!0)});return()=>w()},[]),W.useEffect(()=>{const w={2028:"Freshmen",2027:"Sophomores",2026:"Juniors",2025:"Seniors"};o&&((async()=>{try{const ct=(await xd(Vd,"getUser")()).data;m(ct.classYear),b(w[ct.classYear]);const st=ct.todaysVotes,It={...st};return Object.keys(st).forEach(D=>{It[D]=I-st[D]}),ht(It),ct.classYear}catch(Et){console.error("Failed to fetch class year:",Et)}})(),l2("students").then(Et=>{const Z=Et.sort((ct,st)=>st.score-ct.score||ct.name.localeCompare(st.name));t(Z)}))},[o]),W.useEffect(()=>{const w=xd(Vd,"fetchVotesAndGeneratePairs");if(!o||!E)return;(async()=>{let Et=r;if(E==="All")s(Et);else{const st=uN[E];Et=r.filter(It=>It.class_year===st),s(Et)}if(V[E].length>0){mt(F[E]+1);return}if(!o||Et.length<2)return;X(!0);const ct=(await w({collection:"students",uid:o.uid,subset:E})).data;if(ct.length===0){X(!1);return}B(st=>({...st,[E]:ct})),rt(st=>({...st,[E]:0})),X(!1)})()},[E,r,o,f,V,F]);const S=async()=>{const w=new Hi;try{const Ct=await gO(Va,w),Et=(Ct==null?void 0:Ct.user)||Va.currentUser,Z=Et==null?void 0:Et.email;Z!=null&&Z.endsWith("@yale.edu")||(alert("Only yale.edu emails are allowed"),await Ud(Va))}catch(Ct){console.error("Login error:",Ct)}},C=async()=>{await Ud(Va)},N=async(w,Ct)=>{rt(Y=>({...Y,[E]:Y[E]+1})),mt(bt+1);const Et=n[w.entry1],Z=n[w.entry2],ct=1/(1+Math.pow(10,(Z.score-Et.score)/400)),st=1/(1+Math.pow(10,(Et.score-Z.score)/400));let It=Et.score,D=Z.score;Ct===0?(It+=M*(1-ct),D+=M*(0-st)):Ct===1&&(It+=M*(0-ct),D+=M*(1-st)),t(Y=>{const at=[...Y],nt=at.findIndex(vt=>vt.id===Et.id),it=at.findIndex(vt=>vt.id===Z.id);return nt!==-1&&(at[nt]={...Et,score:It}),it!==-1&&(at[it]={...Z,score:D}),at.sort((vt,Tt)=>Tt.score-vt.score||vt.name.localeCompare(Tt.name))}),s(Y=>{const at=[...Y];return at[w.entry1]={...Et,score:It},at[w.entry2]={...Z,score:D},at.sort((nt,it)=>it.score-nt.score||nt.name.localeCompare(it.name)),at});try{await Ot({collectionName:"students",entry1Id:Et.id,entry2Id:Z.id,mode:Ct,subcategory:E})}catch(Y){console.error("Error calling updateEloRating:",Y)}};if(!p)return tt.jsxs("div",{className:"relative flex items-center justify-center min-h-[100dvh] bg-gray-100",children:[tt.jsx(wc,{}),tt.jsx("div",{className:"w-12 h-12 border-4 border-blue-500 border-t-transparent rounded-full animate-spin"})]});if(!o)return tt.jsxs("div",{className:"flex items-center justify-center min-h-[100dvh] bg-gray-100 flex-col gap-8",children:[tt.jsx(wc,{}),tt.jsx("div",{className:"text-6xl sm:text-8xl font-bold font-['Knewave'] tracking-wide z-10",children:"RANKYALE"}),tt.jsx("div",{className:"text-lg sm:text-xl italic font-light mx-10 text-center z-10",children:"Who is the most popular student?"}),tt.jsx("button",{onClick:S,className:"bg-blue-600 text-white px-6 py-3 text-lg rounded-lg shadow hover:bg-blue-700 transition z-10 cursor-pointer",children:"Sign in with your Yale email"})]});const U=n.length===0;return tt.jsxs(tt.Fragment,{children:[tt.jsx(wc,{}),tt.jsx(FT,{handleLogout:C}),tt.jsxs("div",{className:"flex flex-col w-full min-h-[100dvh] z-10 relative",children:[tt.jsxs("div",{className:"flex flex-col items-center w-full",children:[tt.jsx("h1",{className:"text-4xl sm:text-5xl font-bold mt-4 sm:mt-0 mb-8 sm:mb-8 text-center bg-clip-text z-10",children:"Who is the Most Popular Student?"}),!U&&tt.jsx("div",{className:"flex bg-white rounded-lg shadow-md p-1 mb-2 text-xs sm:text-base z-10",children:["All","Freshmen","Sophomores","Juniors","Seniors"].map(w=>tt.jsx("button",{onClick:()=>b(w),className:`px-3 sm:px-6 py-2 rounded-md transition-colors duration-200 cursor-pointer ${E===w?"bg-blue-500 text-white":"text-gray-600 hover:bg-gray-100"}`,children:w},w))}),tt.jsx(lN,{pairs:V[E],currentPairIndex:bt,entriesSubset:n,onVote:N,remainingVotes:ut[E],valid:!0,isPairsLoading:Q},E)]}),tt.jsx("div",{className:"flex flex-col items-center w-full",children:U?tt.jsx("div",{className:"fixed inset-0 flex items-center justify-center",children:tt.jsx("div",{className:"w-16 h-16 border-4 border-blue-500 border-t-transparent rounded-full animate-spin"})}):tt.jsx("div",{className:"flex flex-col items-center mx-3 sm:mx-0 sm:w-full space-y-3",children:n.slice(0,100).map((w,Ct)=>tt.jsxs("div",{className:"bg-white/50 backdrop-blur-lg rounded-xl py-2 px-4 flex flex-row justify-between items-center space-x-4 w-full max-w-xl shadow-xs",children:[tt.jsxs("div",{className:"flex flex-row gap-4 text-xl font-medium",children:[tt.jsx("span",{children:Ct+1}),tt.jsx("span",{className:"sm:text-xl text-lg",children:w.name})]}),tt.jsx("img",{src:w.image==="assets/defaultStudent.avif"?"/defaultStudent.png":w.image,alt:w.name,className:"h-16 object-contain rounded-md"})]},w.email??w.name))})})]}),tt.jsx(GT,{})]})}const hN=()=>tt.jsxs(tt.Fragment,{children:[tt.jsx(wc,{}),tt.jsxs("div",{className:"min-h-screen flex flex-col relative",children:[tt.jsx(FT,{handleLogout:()=>Promise.resolve()}),tt.jsxs("div",{className:"text-center p-5 relative z-10 flex-1",children:[tt.jsx("h1",{className:"text-[1.8rem] sm:text-4xl font-bold sm:mt-24 mb-4",children:"Welcome to Rank Yale 🏆"}),tt.jsxs("div",{className:"flex flex-col justify-center items-center text-base sm:text-xl max-w-xl mx-auto gap-8 my-8",children:[tt.jsx("p",{children:"Rank Yale is a toxic website for ranking the popularity of Yale students. My name is Addison Goolsbee and I have too much time on my hands. Here's my horrendous Yalies photo, hopefully yours is a little better:"}),tt.jsx("img",{src:"https://yalestudentphotos.s3.amazonaws.com/3ab9ef532e796c8afef63d6dcd253773.jpg",alt:"A humorous depiction of me",className:"w-48 h-56 rounded-lg mx-auto mb-4 object-cover"}),tt.jsxs("div",{children:["I love feedback! Fill out ",tt.jsx("a",{href:"https://forms.gle/Pqmeex4c6ubKRDAh8",target:"_blank",rel:"noopener noreferrer",className:"text-blue-400 hover:text-blue-500 transition-all duration-300 underline",children:"this anonymous google form"})," to let me know what you think. Also check out"," ",tt.jsx("a",{href:"https://addisongoolsbee.com",target:"_blank",rel:"noopener noreferrer",className:"text-blue-400 hover:text-blue-500 transition-all duration-300 underline",children:"my website"}),"."]})]})]}),tt.jsx(GT,{})]})]});function fN(){return tt.jsxs(Eb,{children:[tt.jsx(zd,{path:"/",element:tt.jsx(cN,{})}),tt.jsx(zd,{path:"/about",element:tt.jsx(hN,{})})]})}CS.createRoot(document.getElementById("root")).render(tt.jsx(W.StrictMode,{children:tt.jsx(Ib,{future:{v7_startTransition:!0,v7_relativeSplatPath:!0},children:tt.jsx(fN,{})})}));
