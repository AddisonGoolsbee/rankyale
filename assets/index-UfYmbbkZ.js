 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var hv;function TS(){if(hv)return Rt;hv=1;var r=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),n=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),f=Symbol.for("react.context"),m=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),y=Symbol.for("react.memo"),E=Symbol.for("react.lazy"),b=Symbol.iterator;function V(D){return D===null||typeof D!="object"?null:(D=b&&D[b]||D["@@iterator"],typeof D=="function"?D:null)}var B={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},Y=Object.assign,X={};function F(D,Q,at){this.props=D,this.context=Q,this.refs=X,this.updater=at||B}F.prototype.isReactComponent={},F.prototype.setState=function(D,Q){if(typeof D!="object"&&typeof D!="function"&&D!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,D,Q,"setState")},F.prototype.forceUpdate=function(D){this.updater.enqueueForceUpdate(this,D,"forceUpdate")};function rt(){}rt.prototype=F.prototype;function ut(D,Q,at){this.props=D,this.context=Q,this.refs=X,this.updater=at||B}var ht=ut.prototype=new rt;ht.constructor=ut,Y(ht,F.prototype),ht.isPureReactComponent=!0;var bt=Array.isArray,mt={H:null,A:null,T:null,S:null},Ot=Object.prototype.hasOwnProperty;function M(D,Q,at,nt,it,vt){return at=vt.ref,{$$typeof:r,type:D,key:Q,ref:at!==void 0?at:null,props:vt}}function I(D,Q){return M(D.type,Q,void 0,void 0,void 0,D.props)}function S(D){return typeof D=="object"&&D!==null&&D.$$typeof===r}function C(D){var Q={"=":"=0",":":"=2"};return"$"+D.replace(/[=:]/g,function(at){return Q[at]})}var N=/\/+/g;function U(D,Q){return typeof D=="object"&&D!==null&&D.key!=null?C(""+D.key):Q.toString(36)}function w(){}function Ct(D){switch(D.status){case"fulfilled":return D.value;case"rejected":throw D.reason;default:switch(typeof D.status=="string"?D.then(w,w):(D.status="pending",D.then(function(Q){D.status==="pending"&&(D.status="fulfilled",D.value=Q)},function(Q){D.status==="pending"&&(D.status="rejected",D.reason=Q)})),D.status){case"fulfilled":return D.value;case"rejected":throw D.reason}}throw D}function Et(D,Q,at,nt,it){var vt=typeof D;(vt==="undefined"||vt==="boolean")&&(D=null);var Tt=!1;if(D===null)Tt=!0;else switch(vt){case"bigint":case"string":case"number":Tt=!0;break;case"object":switch(D.$$typeof){case r:case t:Tt=!0;break;case E:return Tt=D._init,Et(Tt(D._payload),Q,at,nt,it)}}if(Tt)return it=it(D),Tt=nt===""?"."+U(D,0):nt,bt(it)?(at="",Tt!=null&&(at=Tt.replace(N,"$&/")+"/"),Et(it,Q,at,"",function(ie){return ie})):it!=null&&(S(it)&&(it=I(it,at+(it.key==null||D&&D.key===it.key?"":(""+it.key).replace(N,"$&/")+"/")+Tt)),Q.push(it)),1;Tt=0;var de=nt===""?".":nt+":";if(bt(D))for(var qt=0;qt<D.length;qt++)nt=D[qt],vt=de+U(nt,qt),Tt+=Et(nt,Q,at,vt,it);else if(qt=V(D),typeof qt=="function")for(D=qt.call(D),qt=0;!(nt=D.next()).done;)nt=nt.value,vt=de+U(nt,qt++),Tt+=Et(nt,Q,at,vt,it);else if(vt==="object"){if(typeof D.then=="function")return Et(Ct(D),Q,at,nt,it);throw Q=String(D),Error("Objects are not valid as a React child (found: "+(Q==="[object Object]"?"object with keys {"+Object.keys(D).join(", ")+"}":Q)+"). If you meant to render a collection of children, use an array instead.")}return Tt}function Z(D,Q,at){if(D==null)return D;var nt=[],it=0;return Et(D,nt,"","",function(vt){return Q.call(at,vt,it++)}),nt}function ct(D){if(D._status===-1){var Q=D._result;Q=Q(),Q.then(function(at){(D._status===0||D._status===-1)&&(D._status=1,D._result=at)},function(at){(D._status===0||D._status===-1)&&(D._status=2,D._result=at)}),D._status===-1&&(D._status=0,D._result=Q)}if(D._status===1)return D._result.default;throw D._result}var st=typeof reportError=="function"?reportError:function(D){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var Q=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof D=="object"&&D!==null&&typeof D.message=="string"?String(D.message):String(D),error:D});if(!window.dispatchEvent(Q))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",D);return}console.error(D)};function It(){}return Rt.Children={map:Z,forEach:function(D,Q,at){Z(D,function(){Q.apply(this,arguments)},at)},count:function(D){var Q=0;return Z(D,function(){Q++}),Q},toArray:function(D){return Z(D,function(Q){return Q})||[]},only:function(D){if(!S(D))throw Error("React.Children.only expected to receive a single React element child.");return D}},Rt.Component=F,Rt.Fragment=n,Rt.Profiler=o,Rt.PureComponent=ut,Rt.StrictMode=s,Rt.Suspense=p,Rt.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=mt,Rt.act=function(){throw Error("act(...) is not supported in production builds of React.")},Rt.cache=function(D){return function(){return D.apply(null,arguments)}},Rt.cloneElement=function(D,Q,at){if(D==null)throw Error("The argument must be a React element, but you passed "+D+".");var nt=Y({},D.props),it=D.key,vt=void 0;if(Q!=null)for(Tt in Q.ref!==void 0&&(vt=void 0),Q.key!==void 0&&(it=""+Q.key),Q)!Ot.call(Q,Tt)||Tt==="key"||Tt==="__self"||Tt==="__source"||Tt==="ref"&&Q.ref===void 0||(nt[Tt]=Q[Tt]);var Tt=arguments.length-2;if(Tt===1)nt.children=at;else if(1<Tt){for(var de=Array(Tt),qt=0;qt<Tt;qt++)de[qt]=arguments[qt+2];nt.children=de}return M(D.type,it,void 0,void 0,vt,nt)},Rt.createContext=function(D){return D={$$typeof:f,_currentValue:D,_currentValue2:D,_threadCount:0,Provider:null,Consumer:null},D.Provider=D,D.Consumer={$$typeof:u,_context:D},D},Rt.createElement=function(D,Q,at){var nt,it={},vt=null;if(Q!=null)for(nt in Q.key!==void 0&&(vt=""+Q.key),Q)Ot.call(Q,nt)&&nt!=="key"&&nt!=="__self"&&nt!=="__source"&&(it[nt]=Q[nt]);var Tt=arguments.length-2;if(Tt===1)it.children=at;else if(1<Tt){for(var de=Array(Tt),qt=0;qt<Tt;qt++)de[qt]=arguments[qt+2];it.children=de}if(D&&D.defaultProps)for(nt in Tt=D.defaultProps,Tt)it[nt]===void 0&&(it[nt]=Tt[nt]);return M(D,vt,void 0,void 0,null,it)},Rt.createRef=function(){return{current:null}},Rt.forwardRef=function(D){return{$$typeof:m,render:D}},Rt.isValidElement=S,Rt.lazy=function(D){return{$$typeof:E,_payload:{_status:-1,_result:D},_init:ct}},Rt.memo=function(D,Q){return{$$typeof:y,type:D,compare:Q===void 0?null:Q}},Rt.startTransition=function(D){var Q=mt.T,at={};mt.T=at;try{var nt=D(),it=mt.S;it!==null&&it(at,nt),typeof nt=="object"&&nt!==null&&typeof nt.then=="function"&&nt.then(It,st)}catch(vt){st(vt)}finally{mt.T=Q}},Rt.unstable_useCacheRefresh=function(){return mt.H.useCacheRefresh()},Rt.use=function(D){return mt.H.use(D)},Rt.useActionState=function(D,Q,at){return mt.H.useActionState(D,Q,at)},Rt.useCallback=function(D,Q){return mt.H.useCallback(D,Q)},Rt.useContext=function(D){return mt.H.useContext(D)},Rt.useDebugValue=function(){},Rt.useDeferredValue=function(D,Q){return mt.H.useDeferredValue(D,Q)},Rt.useEffect=function(D,Q){return mt.H.useEffect(D,Q)},Rt.useId=function(){return mt.H.useId()},Rt.useImperativeHandle=function(D,Q,at){return mt.H.useImperativeHandle(D,Q,at)},Rt.useInsertionEffect=function(D,Q){return mt.H.useInsertionEffect(D,Q)},Rt.useLayoutEffect=function(D,Q){return mt.H.useLayoutEffect(D,Q)},Rt.useMemo=function(D,Q){return mt.H.useMemo(D,Q)},Rt.useOptimistic=function(D,Q){return mt.H.useOptimistic(D,Q)},Rt.useReducer=function(D,Q,at){return mt.H.useReducer(D,Q,at)},Rt.useRef=function(D){return mt.H.useRef(D)},Rt.useState=function(D){return mt.H.useState(D)},Rt.useSyncExternalStore=function(D,Q,at){return mt.H.useSyncExternalStore(D,Q,at)},Rt.useTransition=function(){return mt.H.useTransition()},Rt.version="19.0.0",Rt}var fv;function pm(){return fv||(fv=1,md.exports=TS()),md.exports}var tt=pm();const AS=vS(tt),SS=yS({__proto__:null,default:AS},[tt]);var gd={exports:{}},ml={},pd={exports:{}},yd={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var dv;function bS(){return dv||(dv=1,function(r){function t(Z,ct){var st=Z.length;Z.push(ct);t:for(;0<st;){var It=st-1>>>1,D=Z[It];if(0<o(D,ct))Z[It]=ct,Z[st]=D,st=It;else break t}}function n(Z){return Z.length===0?null:Z[0]}function s(Z){if(Z.length===0)return null;var ct=Z[0],st=Z.pop();if(st!==ct){Z[0]=st;t:for(var It=0,D=Z.length,Q=D>>>1;It<Q;){var at=2*(It+1)-1,nt=Z[at],it=at+1,vt=Z[it];if(0>o(nt,st))it<D&&0>o(vt,nt)?(Z[It]=vt,Z[it]=st,It=it):(Z[It]=nt,Z[at]=st,It=at);else if(it<D&&0>o(vt,st))Z[It]=vt,Z[it]=st,It=it;else break t}}return ct}function o(Z,ct){var st=Z.sortIndex-ct.sortIndex;return st!==0?st:Z.id-ct.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;r.unstable_now=function(){return u.now()}}else{var f=Date,m=f.now();r.unstable_now=function(){return f.now()-m}}var p=[],y=[],E=1,b=null,V=3,B=!1,Y=!1,X=!1,F=typeof setTimeout=="function"?setTimeout:null,rt=typeof clearTimeout=="function"?clearTimeout:null,ut=typeof setImmediate<"u"?setImmediate:null;function ht(Z){for(var ct=n(y);ct!==null;){if(ct.callback===null)s(y);else if(ct.startTime<=Z)s(y),ct.sortIndex=ct.expirationTime,t(p,ct);else break;ct=n(y)}}function bt(Z){if(X=!1,ht(Z),!Y)if(n(p)!==null)Y=!0,Ct();else{var ct=n(y);ct!==null&&Et(bt,ct.startTime-Z)}}var mt=!1,Ot=-1,M=5,I=-1;function S(){return!(r.unstable_now()-I<M)}function C(){if(mt){var Z=r.unstable_now();I=Z;var ct=!0;try{t:{Y=!1,X&&(X=!1,rt(Ot),Ot=-1),B=!0;var st=V;try{e:{for(ht(Z),b=n(p);b!==null&&!(b.expirationTime>Z&&S());){var It=b.callback;if(typeof It=="function"){b.callback=null,V=b.priorityLevel;var D=It(b.expirationTime<=Z);if(Z=r.unstable_now(),typeof D=="function"){b.callback=D,ht(Z),ct=!0;break e}b===n(p)&&s(p),ht(Z)}else s(p);b=n(p)}if(b!==null)ct=!0;else{var Q=n(y);Q!==null&&Et(bt,Q.startTime-Z),ct=!1}}break t}finally{b=null,V=st,B=!1}ct=void 0}}finally{ct?N():mt=!1}}}var N;if(typeof ut=="function")N=function(){ut(C)};else if(typeof MessageChannel<"u"){var U=new MessageChannel,w=U.port2;U.port1.onmessage=C,N=function(){w.postMessage(null)}}else N=function(){F(C,0)};function Ct(){mt||(mt=!0,N())}function Et(Z,ct){Ot=F(function(){Z(r.unstable_now())},ct)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(Z){Z.callback=null},r.unstable_continueExecution=function(){Y||B||(Y=!0,Ct())},r.unstable_forceFrameRate=function(Z){0>Z||125<Z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):M=0<Z?Math.floor(1e3/Z):5},r.unstable_getCurrentPriorityLevel=function(){return V},r.unstable_getFirstCallbackNode=function(){return n(p)},r.unstable_next=function(Z){switch(V){case 1:case 2:case 3:var ct=3;break;default:ct=V}var st=V;V=ct;try{return Z()}finally{V=st}},r.unstable_pauseExecution=function(){},r.unstable_requestPaint=function(){},r.unstable_runWithPriority=function(Z,ct){switch(Z){case 1:case 2:case 3:case 4:case 5:break;default:Z=3}var st=V;V=Z;try{return ct()}finally{V=st}},r.unstable_scheduleCallback=function(Z,ct,st){var It=r.unstable_now();switch(typeof st=="object"&&st!==null?(st=st.delay,st=typeof st=="number"&&0<st?It+st:It):st=It,Z){case 1:var D=-1;break;case 2:D=250;break;case 5:D=1073741823;break;case 4:D=1e4;break;default:D=5e3}return D=st+D,Z={id:E++,callback:ct,priorityLevel:Z,startTime:st,expirationTime:D,sortIndex:-1},st>It?(Z.sortIndex=st,t(y,Z),n(p)===null&&Z===n(y)&&(X?(rt(Ot),Ot=-1):X=!0,Et(bt,st-It))):(Z.sortIndex=D,t(p,Z),Y||B||(Y=!0,Ct())),Z},r.unstable_shouldYield=S,r.unstable_wrapCallback=function(Z){var ct=V;return function(){var st=V;V=ct;try{return Z.apply(this,arguments)}finally{V=st}}}}(yd)),yd}var mv;function wS(){return mv||(mv=1,pd.exports=bS()),pd.exports}var vd={exports:{}},He={};/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jc=new $c("@firebase/auth");function c2(r,...t){jc.logLevel<=xt.WARN&&jc.warn(`Auth (${eo}): ${r}`,...t)}function Tc(r,...t){jc.logLevel<=xt.ERROR&&jc.error(`Auth (${eo}): ${r}`,...t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dm(){var r;return typeof self<"u"&&((r=self.location)===null||r===void 0?void 0:r.href)||""}function f2(){return K_()==="http:"||K_()==="https:"}function K_(){var r;return typeof self<"u"&&((r=self.location)===null||r===void 0?void 0:r.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function d2(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(f2()||_m()||"connection"in navigator)?navigator.onLine:!0}function m2(){if(typeof navigator>"u")return null;const r=navigator;return r.languages&&r.languages[0]||r.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qc(r){var t;const n=r.auth,s=await r.getIdToken(),o=await Ml(r,_T(n,{idToken:s}));_t(o==null?void 0:o.users.length,n,"internal-error");const u=o.users[0];r._notifyReloadListener(u);const f=!((t=u.providerUserInfo)===null||t===void 0)&&t.length?ET(u.providerUserInfo):[],m=b2(r.providerData,f),p=r.isAnonymous,y=!(r.email&&u.passwordHash)&&!(m!=null&&m.length),E=p?y:!1,b={uid:u.localId,displayName:u.displayName||null,photoURL:u.photoUrl||null,email:u.email||null,emailVerified:u.emailVerified||!1,phoneNumber:u.phoneNumber||null,tenantId:u.tenantId||null,providerData:m,metadata:new mm(u.createdAt,u.lastLoginAt),isAnonymous:E};Object.assign(r,b)}async function S2(r){const t=cn(r);await qc(t),await t.auth._persistUserIfCurrent(t),t.auth._notifyListenersIfCurrent(t)}function b2(r,t){return[...r.filter(s=>!t.some(o=>o.providerId===s.providerId)),...t]}function ET(r){return r.map(t=>{var{providerId:n}=t,s=Zm(t,["providerId"]);return{providerId:n,uid:s.rawId||"",displayName:s.displayName||null,email:s.email||null,phoneNumber:s.phoneNumber||null,photoURL:s.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function O2(r,t={}){return ao(r,"GET","/v2/passwordPolicy",eg(r,t))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let rg={async loadJS(){throw new Error("Unable to load external scripts")},recaptchaV2Script:"",recaptchaEnterpriseScript:"",gapiScript:""};function V2(r){rg=r}function k2(r){return rg.loadJS(r)}function U2(){return rg.gapiScript}function L2(r){return`__${r}${Math.floor(Math.random()*1e6)}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Fa(r,t){return y2(r,"POST","/v1/accounts:signInWithIdp",eg(r,t))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function G2(r,t,n=!1){const{auth:s}=r;if(Un(s.app))return Promise.reject(ks(s));const o="reauthenticate";try{const u=await Ml(r,xT(s,o,t,r),n);_t(u.idToken,s,"internal-error");const f=ng(u.idToken);_t(f,s,"internal-error");const{sub:m}=f;return _t(r.uid===m,s,"user-mismatch"),Wa._forOperation(r,o,u)}catch(u){throw(u==null?void 0:u.code)==="auth/user-not-found"&&gi(s,"user-mismatch"),u}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
